...
@Service
public class ShunanpayPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(ShunanpayPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理顺安支付回调】";
        _log.info("====== 开始处理顺安支付回调通知 ======");
