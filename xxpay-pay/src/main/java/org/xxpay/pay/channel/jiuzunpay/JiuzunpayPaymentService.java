package org.xxpay.pay.channel.jiuzunpay;
...
@Service
public class JiuzunpayPaymentService extends BasePayment {

    private static final MyLog _log = MyLog.getLog(JiuzunpayPaymentService.class);

    @Override
    public String getChannelName() {
        return PayConstant.CHANNEL_NAME_JIUZUN;
    }
    ...
    public JSONObject pay(PayOrder payOrder) {
        ...
        switch (channelName) {
            case PayConstant.newTradeTypeConstant.TRADE_TYPE_ALIPAY:
                retObj = doJuheRyPayReq(payOrder, "914"); //支付宝H5
                break;
            case PayConstant.newTradeTypeConstant.TRADE_TYPE_WXPAY:
                retObj = doJuheRyPayReq(payOrder, "913"); //微信H5
                break;
            default:
    ...
    public JSONObject query(PayOrder payOrder) {
        ...
        try {
            ...
            if (code.equals("00")) {
                ...
                System.out.println("九尊------》》》》》》《《《《《《++++++" + map1.toString());
