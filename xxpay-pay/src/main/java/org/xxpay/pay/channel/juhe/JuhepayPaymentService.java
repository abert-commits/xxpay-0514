package org.xxpay.pay.channel.juhe;
...
@Service
public class JuhepayPaymentService extends BasePayment {

    private static final MyLog _log = MyLog.getLog(JuhepayPaymentService.class);

    @Override
    public String getChannelName() {
        return PayConstant.CHANNEL_NAME_JUHE;
    }
    ...
    public JSONObject pay(PayOrder payOrder) {
        ...
        switch (channelName) {
            case PayConstant.newTradeTypeConstant.TRADE_TYPE_ALIPAY_PDDSDK:
                retObj = doJuheRyPayReq(payOrder, "962"); //支付宝拼多多
                break;
            default:
    ...
    public JSONObject query(PayOrder payOrder) {
        ...
        try {
            ...
            if (code.equals("00")) {
                ...
                System.out.println("聚合------》》》》》》《《《《《《++++++" + map1.toString());
