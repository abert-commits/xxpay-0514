...
@Service
public class YuzhouPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(YuzhouPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理宇宙支付回调】";
        _log.info("====== 开始处理宇宙支付回调通知 ======");
