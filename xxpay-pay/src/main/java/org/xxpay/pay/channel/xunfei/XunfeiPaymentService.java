...
@Service
public class XunfeiPaymentService extends BasePayment {

    private static final MyLog _log = MyLog.getLog(XunfeiPaymentService.class);
    ...
    public JSONObject pay(PayOrder payOrder) {
        ...
        switch (channelName) {
            ...
            case PayConstant.newTradeTypeConstant.TRADE_TYPE_ALIPAY:
                retObj = doMayiPayReq(payOrder, "979");
                break;
            default:
