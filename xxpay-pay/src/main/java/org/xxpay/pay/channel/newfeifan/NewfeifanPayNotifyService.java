...
@Service
public class NewfeifanPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(NewfeifanPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理新非凡支付回调】";
        _log.info("====== 开始处理新非凡支付回调通知 ======");
