...
@Service
public class LongtengPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(LongtengPayNotifyService.class);
    ...
    public boolean verifyPayParams(Map<String, Object> payContext) throws Exception {
        ...
        String ovalue = params.getString("ovalue"); //支付金额
        String opstate = params.getString("opstate"); //状态
        ...
        // md5 加密
        String md5 = PayDigestUtil.md5(String.format("orderid=%s&opstate=%s&ovalue=%s",orderid,opstate,ovalue)+channelPayConfig.getmD5Key(),"utf-8" );
        if (!md5.equals(sign)) {
