...
@Service
public class XixiliPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(XixiliPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理西溪里支付回调】";
        _log.info("====== 开始处理西溪里支付回调通知 ======");
