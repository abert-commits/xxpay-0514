package org.xxpay.pay.channel.laixpay;
...
@Service
public class LaikepayPaymentService extends BasePayment {

    private static final MyLog _log = MyLog.getLog(LaikepayPaymentService.class);

    @Override
    public String getChannelName() {
        return PayConstant.CHANNEL_NAME_LAIKE;
    }
    ...
    public JSONObject pay(PayOrder payOrder) {
        ...
        switch (channelName) {
            case PayConstant.newTradeTypeConstant.TRADE_TYPE_ALIPAY:
                retObj = doJuheRyPayReq(payOrder, "916"); //支付宝H5
                break;
            default:
    ...
    public JSONObject doJuheRyPayReq(PayOrder payOrder, String pay_code) {
        ...
        try {
            ...
            String res = (String) XXPayUtil.doPostQueryCmd(channelPayConfig.getReqUrl() + "/pay.php",sendMsg);
    ...
    public JSONObject query(PayOrder payOrder) {
        ...
        try {
            ...
            if (code.equals("00")) {
                ...
                System.out.println("莱兄------》》》》》》《《《《《《++++++" + map1.toString());
