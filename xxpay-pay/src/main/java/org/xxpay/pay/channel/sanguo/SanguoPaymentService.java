...
@Service
public class SanguoPaymentService extends BasePayment {
    ...
    public JSONObject pay(PayOrder payOrder) {
        ...
        switch (channelName) {
            ...
            case PayConstant.newTradeTypeConstant.TRADE_TYPE_WXPAY_SDK:
                ...
                break;
            //当当支付
            case  PayConstant.newTradeTypeConstant.TRADE_TYPE_DANGDANG:
                retObj = doMayiPayReq(payOrder, "alipay");//当当支付
                break;
            default:
