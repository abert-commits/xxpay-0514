...
@Service
public class DinghongpayPaymentService extends BasePayment {
    ...
    public JSONObject pay(PayOrder payOrder) {
        ...
        switch (channelName) {
            case PayConstant.newTradeTypeConstant.TRADE_TYPE_ALIPAYQR:
                retObj = doDingHongRyPayReq(payOrder, "911"); //pay.alipay.scan支付宝扫码
                break;
            default:
    ...
    public JSONObject doDingHongRyPayReq(PayOrder payOrder, String pay_code) {
        ...
        try {
            ...
            map.put("order_time", DateUtil.date2Str(new Date(), DateUtil.FORMAT_YYYY_MM_DD_HH_MM_SS)); //请求时间
            map.put("pay_code", pay_code);//支付方式
            map.put("return_url", "127.0.0.1");// 同步跳转地址
//            map.put("key","$2y$10$YCJ1PkNmlBzm1Fm0r9wfpPu8oH4WnoSevO1ir249kHgBSkQDYPa5oa");//key
//            map.put("cuid", payOrder.getMchId());//商户用户Id
            map.put("attach", "鼎红支付");
            ...
            String res = XXPayUtil.postJson(channelPayConfig.getReqUrl() + "/pay", jsonObj.toJSONString());
            _log.info(logPrefix + "******************上游返回数据:{}", res);
            JSONObject resObj = JSONObject.parseObject(res);
            if (resObj.getString("respCode").equals("1")) {
                String payDinghongUrl = resObj.getString("pay_url");
    ...
    public JSONObject query(PayOrder payOrder) {
        ...
        try {
            ...
            if (code.equals("0000")) {
                ...
                System.out.println("鼎红------》》》》》》《《《《《《++++++" + map1.toString());
