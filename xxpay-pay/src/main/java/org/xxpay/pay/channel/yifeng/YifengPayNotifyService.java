...
@Service
public class YifengPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(YifengPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理一风支付回调】";
        _log.info("====== 开始处理一风支付回调通知 ======");
