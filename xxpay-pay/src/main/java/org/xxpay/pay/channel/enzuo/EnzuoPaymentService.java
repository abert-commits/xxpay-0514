package org.xxpay.pay.channel.enzuo;
...
@Service
public class EnzuoPaymentService extends BasePayment {

    private static final MyLog _log = MyLog.getLog(EnzuoPaymentService.class);

    @Override
    public String getChannelName() {
        return PayConstant.CHANNEL_NAME_ENZUO;
    }
    ...
    public JSONObject pay(PayOrder payOrder) {
        ...
        switch (channelName) {
            case PayConstant.newTradeTypeConstant.TRADE_TYPE_ALIPAY:
                retObj = doHuaFeiPayReq(payOrder, "8006"); //pay.alipay.h5 支付宝H5
                break;
            default:
    ...
    public JSONObject doHuaFeiPayReq(PayOrder payOrder, String channel) {
        ...
        try {
            ...
            jsonMap.put("params",map.toJSONString());
            String sendMsg=XXPayUtil.mapToString(jsonMap).replace(">", "");
