package org.xxpay.pay.channel.gofupay;
...
@Service
public class GofupayPaymentService extends BasePayment {

    private static final MyLog _log = MyLog.getLog(GofupayPaymentService.class);

    @Override
    public String getChannelName() {
        return PayConstant.CHANNEL_NAME_GOFU;
    }
    ...
    public JSONObject pay(PayOrder payOrder) {
        ...
        switch (channelName) {
            case PayConstant.newTradeTypeConstant.TRADE_TYPE_ALIPAYQR:
                retObj = doGofuRyPayReq(payOrder, "903"); //GO支付宝扫码
                break;
            default:
    ...
    public JSONObject doGofuRyPayReq(PayOrder payOrder, String pay_code) {
        String logPrefix = "【Go支付统一下单】";
        ...
        try {
            ...
            if (resObj.getString("code").equals("1")) {
                String payDayuUrl= resObj.getString("url");
    ...
    public JSONObject query(PayOrder payOrder) {
        ...
        try {
            ...
            if (code.equals("00")) {
                ...
                System.out.println("Go------》》》》》》《《《《《《++++++" + map1.toString());
