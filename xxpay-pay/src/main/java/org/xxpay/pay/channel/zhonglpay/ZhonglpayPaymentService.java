package org.xxpay.pay.channel.zhonglpay;
...
@Service
public class ZhonglpayPaymentService extends BasePayment {

    private static final MyLog _log = MyLog.getLog(ZhonglpayPaymentService.class);

    @Override
    public String getChannelName() {
        return PayConstant.CHANNEL_NAME_ZHONGLIAN;
    }
    ...
    public JSONObject pay(PayOrder payOrder) {
        ...
        switch (channelName) {
            case PayConstant.newTradeTypeConstant.TRADE_TYPE_ALIPAY_XJ:
                retObj = zhonglpayRyPayReq(payOrder, "ALIPAY_PC");
                break;
            case PayConstant.newTradeTypeConstant.TRADE_TYPE_ALIPAY_PDD:
                retObj = zhonglpayRyPayReq(payOrder, "ALIPAY_PC");
                break;
            case PayConstant.newTradeTypeConstant.TRADE_TYPE_ALIPAY:
                retObj = zhonglpayRyPayReq(payOrder, "ALIPAY_APP");
                break;
            case PayConstant.newTradeTypeConstant.TRADE_TYPE_WXPAY:
                retObj = zhonglpayRyPayReq(payOrder, "WEIXIN_H5");
                break;
            default:
    ...
    public JSONObject zhonglpayRyPayReq(PayOrder payOrder, String pay_code) {
        String logPrefix = "【众联统一下单】";
