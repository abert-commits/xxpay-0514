...
@Service
public class JiupayPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(JiupayPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理玖玖付回调】";
        _log.info("====== 开始处理玖玖付回调通知 ======");
    ...
    public boolean verifyPayParams(Map<String, Object> payContext) throws Exception {
        ...
        String ckSign = PayDigestUtil.getSign(signMap, channelPayConfig.getmD5Key()).toUpperCase();
        _log.info("玖玖付回调 签名生成：" + ckSign);
