...
@Service
public class JufengpayPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(JufengpayPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理飓风支付回调】";
        _log.info("====== 开始处理飓风支付回调通知 ======");
