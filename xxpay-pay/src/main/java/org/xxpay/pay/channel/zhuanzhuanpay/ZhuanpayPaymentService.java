...
@Service
public class ZhuanpayPaymentService extends BasePayment {

    private static final MyLog _log = MyLog.getLog(ZhuanpayPaymentService.class);
    ...
    public JSONObject doMayiPayReq(PayOrder payOrder, String channel) {
        ...
        try {
            ...
            map.put("PayType", channelPayConfig.getChannelId());//支付渠道
