...
@Service
public class JiaowawaPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(JiaowawaPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        ...
        try {
            ...
            if ("1".equals(params.get("returncode"))) {
    ...
    public boolean verifyPayParams(Map<String, Object> payContext) throws Exception {
        ...
        // 校验结果是否成功
        String returncode = params.getString("returncode");  //售卡结果
        String userid = params.getString("userid"); // 商户ID
        ...
        String md5 = "returncode=" + returncode + "&userid=" + userid + "&orderid=" + orderid + "&money=" + money + "&keyvalue=" + channelPayConfig.getmD5Key();

        // md5 加密
        md5 = PayDigestUtil.md5(md5, "utf-8").toLowerCase();
        if (!md5.equals(sign)) {
