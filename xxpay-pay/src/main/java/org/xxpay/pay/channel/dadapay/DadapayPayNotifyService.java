...
@Service
public class DadapayPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(DadapayPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理DD支付回调】";
        _log.info("====== 开始处理DD支付回调通知 ======");
