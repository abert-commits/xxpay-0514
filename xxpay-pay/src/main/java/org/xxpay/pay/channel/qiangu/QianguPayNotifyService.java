...
@Service
public class QianguPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(QianguPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理千古闲鱼回调】";
        _log.info("====== 开始处理千古闲鱼回调通知 ======");
    ...
    public boolean verifyPayParams(Map<String, Object> payContext) throws Exception {
        ...
        // 校验结果是否成功
        String orderNo = params.getString("order_sn"); // 商户唯一订单号
        String amount = params.getString("total");
        ...
        String md5Str = channelPayConfig.getmD5Key() + "callbacks" + params.getString("callbacks") + "order_sn" + params.getString("order_sn") +
                "paytime" + params.getString("paytime") + "total" + params.getString("total") + channelPayConfig.getmD5Key();
        // md5 加密
        String md5 = PayDigestUtil.md5(md5Str, "utf-8");
        if (!md5.equals(sign)) {
