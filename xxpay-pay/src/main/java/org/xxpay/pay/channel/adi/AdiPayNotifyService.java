...
@Service
public class AdiPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(AdiPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理阿弟付支付回调】";
        _log.info("====== 开始处理阿弟付支付回调通知 ======");
