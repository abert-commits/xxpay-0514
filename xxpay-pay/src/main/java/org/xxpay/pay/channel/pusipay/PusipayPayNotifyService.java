...
@Service
public class PusipayPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(PusipayPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理Ypay支付回调】";
        _log.info("====== 开始处理Ypay支付回调通知 ======");
