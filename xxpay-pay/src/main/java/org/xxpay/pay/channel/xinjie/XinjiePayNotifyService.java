...
@Service
public class XinjiePayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(XinjiePayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理信捷微信直充回调】";
        _log.info("====== 开始处理信捷微信直充回调通知 ======");
    ...
    public boolean verifyPayParams(Map<String, Object> payContext) throws Exception {
        ...
        String signStr = orderNo + amount + channelPayConfig.getmD5Key();
        // md5 加密
