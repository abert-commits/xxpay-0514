package org.xxpay.pay.channel.shanghe;
...
@Service
public class ShanghePaymentService extends BasePayment {

    private static final MyLog _log = MyLog.getLog(ShanghePaymentService.class);

    @Override
    public String getChannelName() {
        return PayConstant.CHANNEL_NAME_SHANGHE;
    }
    ...
    public JSONObject pay(PayOrder payOrder) {
        ...
        switch (channelName) {
            ...
            case PayConstant.newTradeTypeConstant.TRADE_TYPE_ALIPAY:
                retObj = doMayiPayReq(payOrder, "968");
                break;
            //微信H5
            case PayConstant.newTradeTypeConstant.TRADE_TYPE_WXPAY:
                retObj = doMayiPayReq(payOrder, "956");
                break;
            default:
