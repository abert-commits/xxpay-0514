package org.xxpay.pay.channel.wo;
...
@Service
public class WoPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(WoPayNotifyService.class);

    @Override
    public String getChannelName() {
        return PayConstant.CHANNEL_NAME_WOPAY;
    }

    @Override
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理沃支付回调】";
        _log.info("====== 开始处理沃支付回调通知 ======");
