...
@Service
public class BaixiongPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(BaixiongPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理白熊支付回调】";
        _log.info("====== 开始处理白熊支付回调通知 ======");
