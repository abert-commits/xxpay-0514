...
@Service
public class FankaPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(FankaPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理凡卡支付回调】";
        _log.info("====== 开始处理凡卡支付回调通知 ======");
