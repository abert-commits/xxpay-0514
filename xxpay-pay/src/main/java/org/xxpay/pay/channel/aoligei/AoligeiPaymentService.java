...
@Service
public class AoligeiPaymentService extends BasePayment {

    private static final MyLog _log = MyLog.getLog(AoligeiPaymentService.class);
    ...
    public JSONObject doMayiPayReq(PayOrder payOrder, String channel) {
        ...
        try {
            ...
            String payUrl = resObj.getJSONObject("data").getString("sdk_orderstr");
