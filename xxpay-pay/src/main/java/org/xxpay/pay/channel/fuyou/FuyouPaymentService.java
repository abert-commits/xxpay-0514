package org.xxpay.pay.channel.fuyou;
...
@Service
public class FuyouPaymentService extends BasePayment {

    private static final MyLog _log = MyLog.getLog(FuyouPaymentService.class);

    @Override
    public String getChannelName() {
        return PayConstant.CHANNEL_NAME_FUYOU;
    }
    ...
    public JSONObject doHuaFeiPayReq(PayOrder payOrder, String channel) {
        ...
        try {
            ...
            String res = XXPayUtil.doPostQueryCmd(channelPayConfig.getReqUrl() + "/sh-fdp-gateway/gateway/api/payRequest.do?format=json", sendMsg, "utf-8", "application/x-www-form-urlencoded");
