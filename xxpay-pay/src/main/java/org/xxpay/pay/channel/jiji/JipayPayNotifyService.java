...
@Service
public class JipayPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(JipayPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理JJ闲鱼回调】";
        _log.info("====== 开始处理JJ闲鱼回调通知 ======");
