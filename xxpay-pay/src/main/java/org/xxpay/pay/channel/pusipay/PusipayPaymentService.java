package org.xxpay.pay.channel.pusipay;
...
@Service
public class PusipayPaymentService extends BasePayment {

    private static final MyLog _log = MyLog.getLog(PusipayPaymentService.class);

    @Override
    public String getChannelName() {
        return PayConstant.CHANNEL_NAME_PUSIPAY;
    }
    ...
    public JSONObject pay(PayOrder payOrder) {
        ...
        switch (channelName) {
            case PayConstant.newTradeTypeConstant.TRADE_TYPE_ALIPAY:
                retObj = doPusiPayReq(payOrder, "8007");//支付宝H5
                break;
            case PayConstant.newTradeTypeConstant.TRADE_TYPE_ALIPAY_SDK:
                retObj = doPusiPayReq(payOrder, "8007");//支付宝sdk
                break;
            case PayConstant.newTradeTypeConstant.TRADE_TYPE_WXPAY:
                retObj = doPusiPayReq(payOrder, "8003"); //微信H5
                break;
            default:
    ...
    public JSONObject doPusiPayReq(PayOrder payOrder, String channel) {
