package org.xxpay.pay.channel.wulala;
...
@Service
public class WulalaPaymentService extends BasePayment {

    private static final MyLog _log = MyLog.getLog(WulalaPaymentService.class);
