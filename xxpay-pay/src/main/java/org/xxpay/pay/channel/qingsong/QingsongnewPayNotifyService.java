package org.xxpay.pay.channel.qingsong;//QingsongnewPayNotifyService
...
@Service
public class QingsongnewPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(QingsongnewPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理轻松支付回调】";
        _log.info("====== 开始处理轻松支付回调通知 ======");
