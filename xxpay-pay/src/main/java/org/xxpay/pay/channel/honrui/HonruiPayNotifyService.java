package org.xxpay.pay.channel.honrui;
...
@Service
public class HonruiPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(HonruiPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理宏瑞付支付回调】";
        _log.info("====== 开始处理宏瑞付支付回调通知 ======");
