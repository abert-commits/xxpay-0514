package org.xxpay.pay.channel.haizeiwang;
...
@Service
public class HaizeiwPaymentService extends BasePayment {

    private static final MyLog _log = MyLog.getLog(HaizeiwPaymentService.class);

    @Override
    public String getChannelName() {
        return PayConstant.CHANNEL_NAME_HAIZEIWPAY;
    }
    ...
    public JSONObject pay(PayOrder payOrder) {
        ...
        switch (channelName) {
            case PayConstant.newTradeTypeConstant.TRADE_TYPE_ALIPAY:
                retObj = doWawaPayReq(payOrder, "8023"); //pay.alipay.h5 支付宝H5
                break;
            default:
    ...
    public JSONObject doWawaPayReq(PayOrder payOrder, String channel) {
        ...
        try {
            ...
            String res = XXPayUtil.doPostQueryCmd(channelPayConfig.getReqUrl() + "/api/pay/create_order","params="+sendMsg);
            ...
            if ("SUCCESS".equals(resultCode)) {
                ...
                if(md5.equals(signs)){
                    String payJumpUrl = resObj.getJSONObject("payParams").getString("sdkUrl");
