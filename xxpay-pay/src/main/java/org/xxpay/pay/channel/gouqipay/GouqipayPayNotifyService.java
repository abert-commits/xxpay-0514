...
@Service
public class GouqipayPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(GouqipayPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理枸杞支付回调】";
        _log.info("====== 开始处理枸杞支付回调通知 ======");
