package org.xxpay.pay.channel.xingda;
...
@Service
public class XingdapayPaymentService extends BasePayment {

    private static final MyLog _log = MyLog.getLog(XingdapayPaymentService.class);

    @Override
    public String getChannelName() {
        return PayConstant.CHANNEL_NAME_XINGDA;
    }
    ...
    public JSONObject pay(PayOrder payOrder) {
        ...
        switch (channelName) {
            ...
            case PayConstant.newTradeTypeConstant.TRADE_TYPE_WXPAY:
                retObj = doXingdaPayReq(payOrder, "901");
                break;
            //支付宝H5
            case PayConstant.newTradeTypeConstant.TRADE_TYPE_ALIPAY:
                retObj = doXingdaPayReq(payOrder, "904");
                break;
            default:
