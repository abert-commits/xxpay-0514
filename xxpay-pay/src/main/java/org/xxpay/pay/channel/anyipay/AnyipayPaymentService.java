...
@Service
public class AnyipayPaymentService extends BasePayment {
    ...
    public JSONObject pay(PayOrder payOrder) {
        ...
        switch (channelName) {
            case PayConstant.newTradeTypeConstant.TRADE_TYPE_ALIPAY:
                retObj = doAnyiRyPayReq(payOrder, "alipay"); //支付宝H5
                break;
            default:
    ...
    public JSONObject doAnyiRyPayReq(PayOrder payOrder, String pay_code) {
        String logPrefix = "【安逸支付统一下单】";
        ...
        try {
            ...
            map.put("pid", channelPayConfig.getMchId());//商户号
            ...
            map.put("return_url", payConfig.getReturnUrl(channelName)); //同步通知地址
            map.put("name", "安逸支付");
            ...
            String res = XXPayUtil.doPostQueryCmd(channelPayConfig.getReqUrl() + "/submit.php", sendMsg);
    ...
    public JSONObject query(PayOrder payOrder) {
        ...
        try {
            ...
            if (code.equals("0000")) {
                ...
                System.out.println("安逸------》》》》》》《《《《《《++++++" + map1.toString());
