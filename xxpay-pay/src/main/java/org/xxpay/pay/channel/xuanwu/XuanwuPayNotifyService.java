...
@Service
public class XuanwuPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(XuanwuPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理玄武支付回调】";
        _log.info("====== 开始处理玄武支付回调通知 ======");
