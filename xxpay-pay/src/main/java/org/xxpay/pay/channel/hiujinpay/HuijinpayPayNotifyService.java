package org.xxpay.pay.channel.hiujinpay;
...
@Service
public class HuijinpayPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(HuijinpayPayNotifyService.class);

    @Override
    public String getChannelName() {
        return PayConstant.CHANNEL_NAME_HUIJINPAY;
    }

    @Override
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理汇锦支付回调】";
        _log.info("====== 开始处理汇锦支付回调通知 ======");
