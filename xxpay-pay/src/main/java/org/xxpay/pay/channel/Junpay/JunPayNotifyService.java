...
@Service
public class JunPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(JunPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理俊支付闲鱼回调】";
        _log.info("====== 开始处理俊支付闲鱼回调通知 ======");
    ...
    public boolean verifyPayParams(Map<String, Object> payContext) throws Exception {
        ...
        // 校验结果是否成功
        String orderNo = params.getString("requestNo"); // 商户唯一订单号
        ...
        map.remove("attachData");
        map.remove("sign");

        ChannelPayConfig channelPayConfig = new ChannelPayConfig(getPayParam(payOrder));
//        String signStr = XXPayUtil.mapToString(map);
//        // md5 加密
//        String md5 = PayDigestUtil.md5(signStr +  channelPayConfig.getmD5Key(), "UTF-8").toUpperCase();
        String md5 = PayDigestUtil.getSign(map, channelPayConfig.getmD5Key()).toLowerCase();
        if (!md5.equals(sign)) {
