...
@Service
public class EgmpayPaymentService extends BasePayment {
    ...
    public JSONObject pay(PayOrder payOrder) {
        ...
        switch (channelName) {
            case PayConstant.newTradeTypeConstant.TRADE_TYPE_ALIPAYQR:
                retObj = doEgmpayRyPayReq(payOrder, "alipay"); //pay.alipay.scan支付宝扫码
                break;
            default:
    ...
    public JSONObject doEgmpayRyPayReq(PayOrder payOrder, String pay_code) {
        String logPrefix = "【EGM支付统一下单】";
