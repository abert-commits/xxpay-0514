...
@Service
public class ShanghePayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(ShanghePayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理商河付支付回调】";
        _log.info("====== 开始处理商河付支付回调通知 ======");
