package org.xxpay.pay.channel.ypay;
...
@Service
public class YpayPaymentService extends BasePayment {

    private static final MyLog _log = MyLog.getLog(YpayPaymentService.class);

    @Override
    public String getChannelName() {
        return PayConstant.CHANNEL_NAME_YPAY;
    }
    ...
    public JSONObject pay(PayOrder payOrder) {
        ...
        switch (channelName) {
            case PayConstant.newTradeTypeConstant.TRADE_TYPE_WXPAYZXQR:
                retObj = doHuaFeiPayReq(payOrder, "8031");//pay.weixin.scan微信扫码
                break;
            ...
            case PayConstant.newTradeTypeConstant.TRADE_TYPE_ALIPAY:
                retObj = doHuaFeiPayReq(payOrder, "80000"); //pay.alipay.h5 支付宝H5
                break;*/
            case PayConstant.newTradeTypeConstant.TRADE_TYPE_ALIPAY_PDDSDK:
                retObj = doHuaFeiPayReq(payOrder, "8028"); //pay.alipay.h5 支付宝 SDK
                break;
    ...
    public JSONObject doHuaFeiPayReq(PayOrder payOrder, String channel) {
        ...
        try {
            ...
            if ("SUCCESS".equals(resultCode)) {
                ...
                if (md5.equals(signs)) {
                    String payJumpUrl = resObj.getJSONObject("payParams").getString("qrUrl");
