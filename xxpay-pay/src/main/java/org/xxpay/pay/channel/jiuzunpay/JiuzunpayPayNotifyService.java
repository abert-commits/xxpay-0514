...
@Service
public class JiuzunpayPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(JiuzunpayPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理九尊支付回调】";
        _log.info("====== 开始处理九尊支付回调通知 ======");
