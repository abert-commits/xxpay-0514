...
@Service
public class YunPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(YunPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理云支付回调】";
        _log.info("====== 开始处理云支付回调通知 ======");
    ...
    public boolean verifyPayParams(Map<String, Object> payContext) throws IllegalAccessException {
        ...
        String amount = params.getString("real_amount");                    // 订单金额
        // 查询payOrder记录
        String payOrderId = params.getString("merchant_order_no");
        ...
        String signRes = PayDigestUtil.getSign(map, channelPayConfig.getmD5Key()).toUpperCase();
