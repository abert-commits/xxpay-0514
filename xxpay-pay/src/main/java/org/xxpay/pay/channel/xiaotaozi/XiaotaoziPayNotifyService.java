...
@Service
public class XiaotaoziPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(XiaotaoziPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理小桃子闲鱼回调】";
        _log.info("====== 开始处理小桃子闲鱼回调通知 ======");
