...
@Service
public class HuoshanPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(HuoshanPayNotifyService.class);
