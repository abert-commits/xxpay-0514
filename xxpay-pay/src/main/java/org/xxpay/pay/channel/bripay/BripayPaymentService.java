...
@Service
public class BripayPaymentService extends BasePayment {

    private static final MyLog _log = MyLog.getLog(BripayPaymentService.class);
    ...
    public JSONObject pay(PayOrder payOrder) {
        ...
        switch (channelName) {
            case PayConstant.newTradeTypeConstant.TRADE_TYPE_ALIPAY_XJ:
                retObj = doJuheRyPayReq(payOrder, "926"); //支付宝H5/api/order
                break;
            default:
