...
@Service
public class ShanchengPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(ShanchengPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理山城支付回调】";
        _log.info("====== 开始处理山城支付回调通知 ======");
...
//        JSONObject jsonParam = PayDigestUtil.getJSONParam(request);
    ...
    public boolean verifyPayParams(Map<String, Object> payContext) throws Exception {
        ...
        params.remove("sign");
        // md5 加密
        String str = String.format("partner=%s&out_trade_no=%s&payment_type=%s&trade_status=%s&total_fee=%s&trade_no=%s",
                params.getString("partner"), params.getString("out_trade_no"), params.getString("payment_type"), params.getString("trade_status"), params.getString("total_fee"), params.getString("trade_no"));
        String md5 = PayDigestUtil.md5((str+channelPayConfig.getmD5Key()), "UTF-8");
        if (!md5.equals(sign)) {
