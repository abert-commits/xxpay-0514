...
@Service
public class HuzhouPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(HuzhouPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理虎洲支付回调】";
        _log.info("====== 开始处理虎洲支付回调通知 ======");
