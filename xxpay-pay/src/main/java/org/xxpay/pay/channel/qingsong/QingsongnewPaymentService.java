package org.xxpay.pay.channel.qingsong;//QingsongnewPaymentService
...
@Service
public class QingsongnewPaymentService extends BasePayment {

    private static final MyLog _log = MyLog.getLog(QingsongnewPaymentService.class);
