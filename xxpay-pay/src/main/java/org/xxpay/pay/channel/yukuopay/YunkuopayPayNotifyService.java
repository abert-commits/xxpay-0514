...
@Service
public class YunkuopayPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(YunkuopayPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理云阔支付回调】";
        _log.info("====== 开始处理云阔支付回调通知 ======");
