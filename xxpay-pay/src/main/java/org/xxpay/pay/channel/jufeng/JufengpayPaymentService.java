package org.xxpay.pay.channel.jufeng;
...
@Service
public class JufengpayPaymentService extends BasePayment {

    private static final MyLog _log = MyLog.getLog(JufengpayPaymentService.class);

    @Override
    public String getChannelName() {
        return PayConstant.CHANNEL_NAME_JUFENG;
    }
    ...
    public JSONObject pay(PayOrder payOrder) {
        ...
        switch (channelName) {
            case PayConstant.newTradeTypeConstant.TRADE_TYPE_ALIPAY:
                retObj = doJuheRyPayReq(payOrder, ""); //支付宝原生
                break;
            default:
    ...
    public JSONObject query(PayOrder payOrder) {
        ...
        try {
            ...
            if (code.equals("00")) {
                ...
                System.out.println("飓风------》》》》》》《《《《《《++++++" + map1.toString());
