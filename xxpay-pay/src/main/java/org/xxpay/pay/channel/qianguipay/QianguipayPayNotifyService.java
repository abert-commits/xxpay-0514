...
@Service
public class QianguipayPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(QianguipayPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理钱柜支付回调】";
        _log.info("====== 开始处理钱柜支付回调通知 ======");
