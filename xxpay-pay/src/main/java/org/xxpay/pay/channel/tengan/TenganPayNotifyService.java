...
@Service
public class TenganPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(TenganPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理腾安支付回调】";
        _log.info("====== 开始处理腾安支付回调通知 ======");
