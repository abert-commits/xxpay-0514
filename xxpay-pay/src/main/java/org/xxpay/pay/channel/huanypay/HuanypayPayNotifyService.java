...
@Service
public class HuanypayPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(HuanypayPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        ...
        System.out.println("支付回调参数首页" + request.getParameterMap());
        //获取到JSONObject
//        JSONObject jsonParam = PayDigestUtil.getJSONParam(request);
        ...
        PayOrder payOrder;
        String respString = PayConstant.RETURN_SILVERSPAY_VALUE_SUCCESS;
        try {
