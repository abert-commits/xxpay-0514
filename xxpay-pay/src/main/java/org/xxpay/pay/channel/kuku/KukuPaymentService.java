package org.xxpay.pay.channel.kuku;
...
@Service
public class KukuPaymentService extends BasePayment {

    private static final MyLog _log = MyLog.getLog(KukuPaymentService.class);
