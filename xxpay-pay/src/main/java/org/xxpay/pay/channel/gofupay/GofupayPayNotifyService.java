...
@Service
public class GofupayPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(GofupayPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理Go支付回调】";
        _log.info("====== 开始处理Go支付回调通知 ======");
