...
@Service
public class AizhifuPaymentService extends BasePayment {

    private static final MyLog _log = MyLog.getLog(AizhifuPaymentService.class);
    ...
    public JSONObject doMayiPayReq(PayOrder payOrder, String channel) {
        ...
        try {
            ...
            map.put("pay_productname", "韩信");//商品名称
