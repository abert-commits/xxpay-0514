package org.xxpay.pay.channel.fanka;
...
@Service
public class FankaPaymentService extends BasePayment {

    private static final MyLog _log = MyLog.getLog(FankaPaymentService.class);
