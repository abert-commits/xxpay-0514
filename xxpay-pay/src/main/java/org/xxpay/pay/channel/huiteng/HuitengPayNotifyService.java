...
@Service
public class HuitengPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(HuitengPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理辉腾付支付回调】";
        _log.info("====== 开始处理辉腾付支付回调通知 ======");
