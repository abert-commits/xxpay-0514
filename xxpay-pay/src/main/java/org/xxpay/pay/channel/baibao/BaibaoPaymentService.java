...
@Service
public class BaibaoPaymentService extends BasePayment {

    private static final MyLog _log = MyLog.getLog(BaibaoPaymentService.class);
    ...
    public JSONObject pay(PayOrder payOrder) {
        ...
        switch (channelName) {
            ...
            case PayConstant.newTradeTypeConstant.TRADE_TYPE_WXPAY:
                retObj = doMayiPayReq(payOrder, "917");//917
                break;
            default:
