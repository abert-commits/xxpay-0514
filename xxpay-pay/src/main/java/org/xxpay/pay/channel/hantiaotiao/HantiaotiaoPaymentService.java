...
@Service
public class HantiaotiaoPaymentService extends BasePayment {

    private static final MyLog _log = MyLog.getLog(HantiaotiaoPaymentService.class);
