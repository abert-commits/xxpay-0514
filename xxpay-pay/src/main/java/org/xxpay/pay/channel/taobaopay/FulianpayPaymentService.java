...
@Service
public class FulianpayPaymentService extends BasePayment {

    private static final MyLog _log = MyLog.getLog(FulianpayPaymentService.class);
    ...
    public JSONObject pay(PayOrder payOrder) {
        ...
        switch (channelName) {
            case PayConstant.newTradeTypeConstant.TRADE_TYPE_ALIPAY:
                retObj = doLianzPayReq(payOrder, "alipay");//支付宝H5
                break;
            default:
...
//            String sendMsg = map.toJSONString();
            ...
            if (resultCode.equals("1")) {
                ...
                String payJumpUrl = resObj.getJSONObject("data").getString("link_url");
