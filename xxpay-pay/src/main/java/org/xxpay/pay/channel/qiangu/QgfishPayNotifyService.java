...
@Service
public class QgfishPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(QgfishPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理新千古闲鱼回调】";
        _log.info("====== 开始处理新千古闲鱼回调通知 ======");
    ...
    public boolean verifyPayParams(Map<String, Object> payContext) throws Exception {
        ...
        String amount = params.getString("order_amount");
