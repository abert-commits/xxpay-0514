...
public class SandpayPaymentService extends BasePayment {
    ...
    public JSONObject pay(PayOrder payOrder) {
        ...
        switch (channelId) {
            ...
            case PAY_CHANNEL_SANDPAY_BANK_B2B :
                ...
                break;
            default:
                retObj = buildRetObj(PayConstant.RETURN_VALUE_FAIL, "不支持的杉德渠道[channelId="+channelId+"]");
                break;
        }
        return retObj;
    }
    ...
    public JSONObject query(PayOrder payOrder) {
        ...
        retObj.put("obj", resp.getJSONObject("body"));
     ...
     * @return
     */
    public JSONObject doGatewayReq(PayOrder payOrder, PayMode mode) {
        SandpayConfig sandpayConfig = new SandpayConfig(getPayParam(payOrder));
     ...
     * @return
     */
    public JSONObject doNativeReq(PayOrder payOrder, String payTool) {
        SandpayConfig sandpayConfig = new SandpayConfig(getPayParam(payOrder));
        String reqAddr="/order/create";   //接口报文规范中获取
        ...
        if("000000".equals(respCode)){
            ...
            payInfo.put("codeUrl", resp.getJSONObject("body").getString("qrCode")); // 二维码支付链接
            payInfo.put("codeImgUrl", payConfig.getPayUrl() + "/qrcode_img_get?url=" + resp.getJSONObject("body").getString("qrCode") + "&widht=200&height=200");
