...
@Service
public class EnzuoPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(EnzuoPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理恩佐支付回调】";
        _log.info("====== 开始处理恩佐支付回调通知 ======");
