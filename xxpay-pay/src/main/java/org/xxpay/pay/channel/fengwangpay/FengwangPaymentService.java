package org.xxpay.pay.channel.fengwangpay;
...
@Service
public class FengwangPaymentService extends BasePayment {

    private static final MyLog _log = MyLog.getLog(FengwangPaymentService.class);


    @Override
    public String getChannelName() {
        return PayConstant.CHANNEL_NAME_FENGWANG;
    }
    ...
    public JSONObject pay(PayOrder payOrder) {
        ...
        switch (channelName) {
            case PayConstant.newTradeTypeConstant.TRADE_TYPE_ALIPAY_PDDSDK:
                retObj = doFagRyPayReq(payOrder, ""); //支付宝H5
                break;
            default:
    ...
    public JSONObject doFagRyPayReq(PayOrder payOrder, String channel) {
        String logPrefix = "【蜂王支付统一下单】";
        ...
        try {
            ...
            map.put("paytype", channelPayConfig.getChannelId());//支付类型
            ...
            System.out.println("蜂王支付验签串:<<><><><><><" + "1.0" + channelPayConfig.getMchId() + String.valueOf(amount) + payOrder.getPayOrderId() + payConfig.getNotifyUrl(channelName) +
    ...
    public JSONObject query(PayOrder payOrder) {
        ...
        try {
            ...
            if (code.equals("0000")) {
                ...
                System.out.println("蜂王------》》》》》》《《《《《《++++++" + map1.toString());
