package org.xxpay.pay.channel.dapaopay;
...
@Service
public class DapaoPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(DapaoPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理大炮支付回调】";
        _log.info("====== 开始处理大炮支付回调通知 ======");
