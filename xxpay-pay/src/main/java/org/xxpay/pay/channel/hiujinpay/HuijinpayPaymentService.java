...
@Service
public class HuijinpayPaymentService extends BasePayment {

    private static final MyLog _log = MyLog.getLog(HuijinpayPaymentService.class);
