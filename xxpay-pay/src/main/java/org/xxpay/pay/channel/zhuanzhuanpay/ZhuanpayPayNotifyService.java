package org.xxpay.pay.channel.zhuanzhuanpay;
...
@Service
public class ZhuanpayPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(ZhuanpayPayNotifyService.class);

    @Override
    public String getChannelName() {
        return PayConstant.CHANNEL_NAME_ZHUANPAY;
    }

    @Override
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【赚赚支付回调】";
        _log.info("====== 开始处理赚赚支付回调通知 ======");
        ...
        try {
            ...
            _log.info("赚赚支付回调=============" + params.toJSONString());
