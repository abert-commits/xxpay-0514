...
@Service
public class PhonebillPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(PhonebillPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理韩信租用直充回调】";
        _log.info("====== 开始处理韩信租用直充回调通知 ======");
    ...
    public boolean verifyPayParams(Map<String, Object> payContext) throws Exception {
        ...
        // 校验结果是否成功
        String orderNo = params.getString("merchantNo"); // 商户唯一订单号
