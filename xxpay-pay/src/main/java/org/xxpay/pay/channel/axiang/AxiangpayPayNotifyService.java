package org.xxpay.pay.channel.axiang;
...
@Service
public class AxiangpayPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(AxiangpayPayNotifyService.class);

    @Override
    public String getChannelName() {
        return PayConstant.CHANNEL_NAME_AXIANG;
    }

    @Override
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理阿翔支付回调】";
        _log.info("====== 开始处理阿翔支付回调通知 ======");
    ...
    public boolean verifyPayParams(Map<String, Object> payContext) throws Exception {
        ...
        // md5 加密
        String md5 = AxiangpayPaymentService.getSign(signMap, channelPayConfig.getmD5Key());
        if (!md5.equals(sign)) {
