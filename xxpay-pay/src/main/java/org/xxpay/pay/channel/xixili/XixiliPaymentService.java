package org.xxpay.pay.channel.xixili;
...
@Service
public class XixiliPaymentService extends BasePayment {

    private static final MyLog _log = MyLog.getLog(XixiliPaymentService.class);
    ...
    public JSONObject doMayiPayReq(PayOrder payOrder, String channel) {
        ...
        try {
            ...
            String sendMsg = XXPayUtil.mapToString(map).replace(">", "")+"&content_type=json&biz=append";
