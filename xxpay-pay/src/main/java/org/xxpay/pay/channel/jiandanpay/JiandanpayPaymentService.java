...
@Service
public class JiandanpayPaymentService extends BasePayment {

    private static final MyLog _log = MyLog.getLog(JiandanpayPaymentService.class);
    ...
    public JSONObject pay(PayOrder payOrder) {
        ...
        switch (channelName) {
            case PayConstant.newTradeTypeConstant.TRADE_TYPE_ALIPAY:
                retObj = doJiandanPayReq(payOrder, "31"); //支付宝H5
                break;
            default:
