package org.xxpay.pay.channel.longtong;
...
@Service
public class LongtongpayPaymentService extends BasePayment {

    private static final MyLog _log = MyLog.getLog(LongtongpayPaymentService.class);

    @Override
    public String getChannelName() {
        return PayConstant.CHANNEL_NAME_LONGTONG;
    }
    ...
    public JSONObject pay(PayOrder payOrder) {
        ...
        switch (channelName) {
            case PayConstant.newTradeTypeConstant.TRADE_TYPE_ALIPAY:
                retObj = doLongtongPayReq(payOrder, "928"); //支付宝H5
                break;
            default:
    ...
    public JSONObject doLongtongPayReq(PayOrder payOrder, String pay_code) {
        String logPrefix = "【隆通支付统一下单】";
        ...
        try {
            ...
            map.put("pay_productname", "韩信支付");//商品名称
    ...
    public JSONObject query(PayOrder payOrder) {
        ...
        try {
            ...
            if (code.equals("00")) {
                ...
                System.out.println("隆通------》》》》》》《《《《《《++++++" + map1.toString());
