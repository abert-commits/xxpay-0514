package org.xxpay.pay.channel.wuerpay;
...
@Service
public class WuerpayPaymentService extends BasePayment {

    private static final MyLog _log = MyLog.getLog(WuerpayPaymentService.class);

    @Override
    public String getChannelName() {
        return PayConstant.CHANNEL_NAME_WUER;
    }
    ...
    public JSONObject pay(PayOrder payOrder) {
        ...
        switch (channelName) {
            case PayConstant.newTradeTypeConstant.TRADE_TYPE_ALIPAY:
                retObj = doWuerRyPayReq(payOrder, "935"); //支付宝H5
                break;
            case PayConstant.newTradeTypeConstant.TRADE_TYPE_WXPAY:
                retObj = doWuerRyPayReq(payOrder, "936"); //微信H5
                break;
            default:
    ...
    public JSONObject doWuerRyPayReq(PayOrder payOrder, String pay_code) {
        String logPrefix = "【五二支付统一下单】";
...
//            map.put("payType","json");
            ...
            if (resObj.getString("returncode").equals("00")) {
                String payJumpUrl= resObj.getString("qr_url");
    ...
    public JSONObject query(PayOrder payOrder) {
        ...
        try {
            ...
            if (code.equals("00")) {
                ...
                System.out.println("五二------》》》》》》《《《《《《++++++" + map1.toString());
