...
public class AlipayConfig {
    ...
    public AlipayConfig(String payParam) {
        ...
        this.pid = object.getString("mchId");
        this.appId = object.getString("mD5Key");
        this.alipayPublicKey = object.getString("rsaPublicKey");
        this.privateKey = object.getString("rsaprivateKey");
        this.alipayAccount = object.getString("rsapassWord");
