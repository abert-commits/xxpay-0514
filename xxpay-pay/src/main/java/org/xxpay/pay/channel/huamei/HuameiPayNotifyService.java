...
@Service
public class HuameiPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(HuameiPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理华美付支付回调】";
        _log.info("====== 开始处理华美付支付回调通知 ======");
        ...
        try {
            ...
            if ("4".equals(params.get("fxstatus"))) {
