package org.xxpay.pay.channel.midoupay;
...
@Service
public class MidoupayPaymentService extends BasePayment {

    private static final MyLog _log = MyLog.getLog(MidoupayPaymentService.class);
    ...
    public JSONObject pay(PayOrder payOrder) {
        ...
        switch (channelName) {
            case PayConstant.newTradeTypeConstant.TRADE_TYPE_WXPAY_PDD:
                retObj = doMidouRyPayReq(payOrder, "902"); //微信PDD
                break;
            default:
    ...
    public JSONObject doMidouRyPayReq(PayOrder payOrder, String pay_code) {
        String logPrefix = "【米兜支付统一下单】";
    ...
    public JSONObject query(PayOrder payOrder) {
        ...
        try {
            ...
            if (code.equals("00")) {
                ...
                System.out.println("米兜------》》》》》》《《《《《《++++++" + map1.toString());
