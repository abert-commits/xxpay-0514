...
@Service
public class YizpayPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(YizpayPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理易支支付回调】";
        _log.info("====== 开始处理易支支付回调通知 ======");
