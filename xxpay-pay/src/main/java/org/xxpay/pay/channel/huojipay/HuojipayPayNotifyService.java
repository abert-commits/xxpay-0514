...
@Service
public class HuojipayPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(HuojipayPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理火鸡支付回调】";
        _log.info("====== 开始处理火鸡支付回调通知 ======");
