package org.xxpay.pay.channel.zhanche;
...
@Service
public class ZhanchepayPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(ZhanchepayPayNotifyService.class);

    @Override
    public String getChannelName() {
        return PayConstant.CHANNEL_NAME_ZHANCHE;
    }

    @Override
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理战车支付回调】";
        _log.info("====== 开始处理战车支付回调通知 ======");
    ...
    public boolean verifyPayParams(Map<String, Object> payContext) throws Exception {
        ...
        // md5 加密
        String md5 = PayDigestUtil.getSignNotKey(signMap, "").toUpperCase();
        if (!md5.equals(sign)) {
        ...
        long resAmount = new BigDecimal(total_fee).multiply(new BigDecimal(100)).longValue();
