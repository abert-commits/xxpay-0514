package org.xxpay.pay.channel.lzpay;
...
@Service
public class LianzhongPaymentService extends BasePayment {

    private static final MyLog _log = MyLog.getLog(LianzhongPaymentService.class);
    ...
    public JSONObject pay(PayOrder payOrder) {
        ...
        switch (channelName) {
            ...
            case PayConstant.newTradeTypeConstant.TRADE_TYPE_ALIPAY:
                retObj = doLianzPayReq(payOrder, "8007");//支付宝H5
                break;
            default:
    ...
    public JSONObject doLianzPayReq(PayOrder payOrder, String channel) {
        ...
        try {
            ...
            map.put("appId", channelPayConfig.getRsaprivateKey()); //应用ID
            ...
            if ("SUCCESS".equals(resultCode)) {
                ...
                if (md5.equals(signs)) {
                    ...
                    String payJumpUrl = URLDecoder.decode(resObj.getJSONObject("payParams").getString("payUrl"), "UTF-8");
