...
@Service
public class BianfupayPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(BianfupayPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理便付支付回调】";
        _log.info("====== 开始处理便付支付回调通知 ======");
        ...
        try {
            ...
            params.put("fxid", jsonParam.getString("fxid"));
            params.put("fxddh", jsonParam.getString("fxddh"));
            params.put("fxorder", jsonParam.getString("fxorder"));
            params.put("fxdesc", jsonParam.getString("fxdesc"));
            params.put("fxfee", jsonParam.getString("fxfee"));
            params.put("fxattch", jsonParam.getString("fxattch"));
            params.put("fxstatus", jsonParam.getString("fxstatus"));
            params.put("fxtime", jsonParam.getString("fxtime"));
            params.put("fxsign", jsonParam.getString("fxsign"));
            _log.info("便付支付回调通知报文=============" + params);
    ...
    public boolean verifyPayParams(Map<String, Object> payContext) {
        ...
        // 查询payOrder记录
        String payOrderId = MySeq.getPay().substring(0,3)+ params.getString("fxddh");
