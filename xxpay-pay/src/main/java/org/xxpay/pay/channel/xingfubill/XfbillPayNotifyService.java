...
@Service
public class XfbillPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(XfbillPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理星付话费直充回调】";
        _log.info("====== 开始处理星付话费直充回调通知 ======");
