...
@Service
public class DacaispayPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(DacaispayPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理大财神支付回调】";
        _log.info("====== 开始处理大财神支付回调通知 ======");
