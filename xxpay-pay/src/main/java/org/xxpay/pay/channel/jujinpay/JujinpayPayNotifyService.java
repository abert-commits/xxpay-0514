...
@Service
public class JujinpayPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(JujinpayPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理聚金支付回调】";
        _log.info("====== 开始处理聚金支付回调通知 ======");
