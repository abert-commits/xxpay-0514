...
@Service
public class WudupayPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(WudupayPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理雾都支付回调】";
        _log.info("====== 开始处理雾都支付回调通知 ======");
