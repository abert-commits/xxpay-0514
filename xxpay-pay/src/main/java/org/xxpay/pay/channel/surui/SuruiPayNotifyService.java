...
@Service
public class SuruiPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(SuruiPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理速锐支付回调】";
        _log.info("====== 开始处理速锐支付回调通知 ======");
