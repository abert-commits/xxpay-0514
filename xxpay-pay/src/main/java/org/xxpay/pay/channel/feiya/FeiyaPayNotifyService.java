...
@Service
public class FeiyaPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(FeiyaPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理飞亚支付回调】";
        _log.info("====== 开始处理飞亚支付回调通知 ======");
