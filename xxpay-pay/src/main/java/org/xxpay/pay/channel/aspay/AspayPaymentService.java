...
@Service
public class AspayPaymentService extends BasePayment {

    private static final MyLog _log = MyLog.getLog(AspayPaymentService.class);
    ...
    public JSONObject pay(PayOrder payOrder) {
        ...
        switch (channelName) {
            ...
            case PayConstant.newTradeTypeConstant.TRADE_TYPE_WXPAY_SDK:
                retObj = doAspayPayReq(payOrder, ""); //pay.weixin.h5 微信H5
                break;
            default:
    ...
    public JSONObject doAspayPayReq(PayOrder payOrder, String channel) {
        String logPrefix = "【AS支付宝网关统一下单】";
