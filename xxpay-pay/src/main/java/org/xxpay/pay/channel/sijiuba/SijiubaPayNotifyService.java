...
@Service
public class SijiubaPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(SijiubaPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理498支付回调】";
        _log.info("====== 开始处理498支付回调通知 ======");
