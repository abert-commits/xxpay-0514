...
@Service
public class HanxinwgPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(HanxinwgPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理韩信网关回调】";
        _log.info("====== 开始处理韩信网关回调通知 ======");
    ...
    public boolean verifyPayParams(Map<String, Object> payContext) throws Exception {
        ...
        // 校验结果是否成功
        String orderNo = params.getString("MchOrder"); // 商户唯一订单号
        ...
        String signStr = ""+map.get("MchName")+map.get("MchOrder")+map.get("Amount")+map.get("Channel")+ channelPayConfig.getmD5Key();  //".ToMD5();//PayDigestUtil.getSign(map, channelPayConfig.getmD5Key()).toUpperCase();
        String sign = PayDigestUtil.md5(signStr, "utf-8");
        _log.info( "******************sign:{}", sign);
        //map.put("Sign", sign); // md5签名

        //String md5 = PayDigestUtil.getSign(map, channelPayConfig.getmD5Key()).toUpperCase();
