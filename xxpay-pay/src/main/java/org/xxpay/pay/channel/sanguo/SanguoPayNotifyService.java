...
@Service
public class SanguoPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(SanguoPayNotifyService.class);
