...
@Service
public class YibpayPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(YibpayPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理易宝话费支付回调】";
        _log.info("====== 开始处理易宝话费支付回调通知 ======");
