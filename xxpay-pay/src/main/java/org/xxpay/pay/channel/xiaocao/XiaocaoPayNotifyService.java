...
@Service
public class XiaocaoPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(XiaocaoPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理小曹直付通回调】";
        _log.info("====== 开始处理小曹直付通回调通知 ======");
