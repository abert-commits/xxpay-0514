package org.xxpay.pay.channel.guangsu;
...
@Service
public class GuangsupayPaymentService extends BasePayment {

    private static final MyLog _log = MyLog.getLog(GuangsupayPaymentService.class);

    @Override
    public String getChannelName() {
        return PayConstant.CHANNEL_NAME_GUAGNSU;
    }
    ...
    public JSONObject pay(PayOrder payOrder) {
        ...
        switch (channelName) {
            case PayConstant.newTradeTypeConstant.TRADE_TYPE_ALIPAY:
                retObj = doJuheRyPayReq(payOrder, "918"); //支付宝h5
                break;
            default:
    ...
    public JSONObject doJuheRyPayReq(PayOrder payOrder, String pay_code) {
        ...
        try {
            ...
            map.put("pay_attach",payOrder.getClientIp());
    ...
    public JSONObject query(PayOrder payOrder) {
        ...
        try {
            ...
            if (code.equals("00")) {
                ...
                System.out.println("光速------》》》》》》《《《《《《++++++" + map1.toString());
