...
@Service
public class DuoduoPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(DuoduoPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理多多付支付回调】";
        _log.info("====== 开始处理多多付支付回调通知 ======");
