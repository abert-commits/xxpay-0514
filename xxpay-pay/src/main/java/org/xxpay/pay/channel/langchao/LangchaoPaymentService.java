package org.xxpay.pay.channel.langchao;
...
@Service
public class LangchaoPaymentService extends BasePayment {

    private static final MyLog _log = MyLog.getLog(LangchaoPaymentService.class);

    @Override
    public String getChannelName() {
        return PayConstant.CHANNEL_NAME_LANGCHAO;
    }
    ...
    public JSONObject pay(PayOrder payOrder) {
        ...
        switch (channelName) {
            ...
            case PayConstant.newTradeTypeConstant.TRADE_TYPE_ALIPAY:
                retObj = doLangChaoPayReq(payOrder, ""); //支付宝 h5
                break;
            default:
    ...
    public JSONObject doLangChaoPayReq(PayOrder payOrder, String channel) {
        String logPrefix = "【浪潮支付统一下单】";
...
//            map.put("extra", ""); //附加参数
            ...
            String res = XXPayUtil.doPostQueryCmd(channelPayConfig.getReqUrl() + "/api/pay/create_order", sendMsg, "utf-8");
