...
@Service
public class KakapayPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(KakapayPayNotifyService.class);

    @Override
    public String getChannelName() {
        return PayConstant.CHANNEL_NAME_KAKA;
    }

    @Override
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理卡卡付支付回调】";
        _log.info("====== 开始处理卡卡付支付回调通知 ======");
