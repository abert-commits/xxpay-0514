...
@Service
public class HaixingPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(HaixingPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理海鑫支付回调】";
        _log.info("====== 开始处理海鑫支付回调通知 ======");
        ...
        try {
            ...
            params.put("fees", request.getParameter("fees"));
    ...
    public boolean verifyPayParams(Map<String, Object> payContext) throws Exception {
        ...
        // md5 加密
        String md5 = HaixingSign.sign(amount,out_trade_no, channelPayConfig.getmD5Key());
        if (!md5.equals(sign)) {
