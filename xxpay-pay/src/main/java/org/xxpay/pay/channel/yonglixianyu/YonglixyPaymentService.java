package org.xxpay.pay.channel.yonglixianyu;//
...
@Service
public class YonglixyPaymentService extends BasePayment {

    private static final MyLog _log = MyLog.getLog(YonglixyPaymentService.class);
...
//            String res = XXPayUtil.doPostQueryCmd(channelPayConfig.getReqUrl() + "/api/unifiedorder",sendMsg, "utf-8");
            ...
            _log.info(logPrefix + "******************sendMsg:{}", res);
            ...
            if ("0".equals(resultCode)) {
                String payJumpUrl = retData.getString("sdk_content");
