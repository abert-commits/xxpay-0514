package org.xxpay.pay.channel.jiuyue;
...
@Service
public class JiuyuepayPaymentService extends BasePayment {

    private static final MyLog _log = MyLog.getLog(JiuyuepayPaymentService.class);

    @Override
    public String getChannelName() {
        return PayConstant.CHANNEL_NAME_JIUYUE;
    }
        ...
        try {
            ...
            if ("SUCCESS".equals(resultCode)) {
                ...
                if (md5.equals(signs)) {
                    ...
                    int result = rpcCommonService.rpcPayOrderService.updateStatus4Ing(payOrder.getPayOrderId(), resObj.getString("payOr derId"));
