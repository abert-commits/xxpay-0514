package org.xxpay.pay.channel.aspay;
...
@Service
public class AspayPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(AspayPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理AS支付宝网关回调】";
        _log.info("====== 开始处理AS支付宝网关回调通知 ======");
