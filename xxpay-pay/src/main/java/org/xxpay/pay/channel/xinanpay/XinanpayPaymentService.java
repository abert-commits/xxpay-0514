...
@Service
public class XinanpayPaymentService extends BasePayment {

    private static final MyLog _log = MyLog.getLog(XinanpayPaymentService.class);

    @Override
    public String getChannelName() {
        return PayConstant.CHANNEL_NAME_XINAN;
    }
    ...
    public JSONObject pay(PayOrder payOrder) {
        ...
        switch (channelName) {
            case PayConstant.newTradeTypeConstant.TRADE_TYPE_ALIPAY:
                retObj = doXinanRyPayReq(payOrder, "916"); //支付宝H5
                break;
            default:
    ...
    public JSONObject query(PayOrder payOrder) {
        ...
        try {
            ...
            if (code.equals("00")) {
                ...
                System.out.println("信安------》》》》》》《《《《《《++++++" + map1.toString());
