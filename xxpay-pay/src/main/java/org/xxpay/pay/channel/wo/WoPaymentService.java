...
@Service
public class WoPaymentService extends BasePayment {

    private static final MyLog _log = MyLog.getLog(WoPaymentService.class);
    ...
    public JSONObject doMayiPayReq(PayOrder payOrder, String channel) {
        ...
        try {
            ...
            map.put("pay_productname", "支付");//商品名称
