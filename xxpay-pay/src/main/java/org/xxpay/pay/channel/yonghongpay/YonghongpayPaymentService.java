package org.xxpay.pay.channel.yonghongpay;
...
@Service
public class YonghongpayPaymentService extends BasePayment {

    private static final MyLog _log = MyLog.getLog(YonghongpayPaymentService.class);

    @Override
    public String getChannelName() {
        return PayConstant.CHANNEL_NAME_YONGHONG;
    }
    ...
    public JSONObject pay(PayOrder payOrder) {
        ...
        switch (channelName) {
            case PayConstant.newTradeTypeConstant.TRADE_TYPE_ALIPAY:
                retObj = doYonghongRyPayReq(payOrder, "130"); //支付宝原生H5
                break;
            default:
    ...
    public JSONObject doYonghongRyPayReq(PayOrder payOrder, String pay_code) {
        String logPrefix = "【勇弘支付统一下单】";
    ...
    public JSONObject query(PayOrder payOrder) {
        ...
        try {
            ...
            if (code.equals("00")) {
                ...
                System.out.println("勇弘------》》》》》》《《《《《《++++++" + map1.toString());
