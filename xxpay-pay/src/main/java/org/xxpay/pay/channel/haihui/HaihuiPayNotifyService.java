...
@Service
public class HaihuiPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(HaihuiPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        ...
        try {
            ...
            JSONObject params =jsonParam;
            _log.info("海汇支付回调=============" + params);
            ...
            if ("2".equals(String.valueOf(params.get("status")) )) {
    ...
    public boolean verifyPayParams(Map<String, Object> payContext) throws Exception {
        ...
        // 校验结果是否成功
        String orderNo = params.getString("merchant_order_no"); // 商户唯一订单号
        ...
        signMap.remove("sign");
        signMap.put("status",String.valueOf(signMap.get("status")) );
        String signStr = XXPayUtil.mapToString(signMap)+"&"+channelPayConfig.getmD5Key();
        String cksign= PayDigestUtil.md5(signStr,"UTF-8");
