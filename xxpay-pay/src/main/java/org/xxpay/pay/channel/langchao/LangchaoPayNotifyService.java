...
@Service
public class LangchaoPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(LangchaoPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理浪潮支付回调】";
        _log.info("====== 开始处理浪潮支付回调通知 ======");
