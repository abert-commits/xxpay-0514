...
@Service
public class WanmeifuPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(WanmeifuPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理完美付支付回调】";
        _log.info("====== 开始处理万久付支付回调通知 ======");
