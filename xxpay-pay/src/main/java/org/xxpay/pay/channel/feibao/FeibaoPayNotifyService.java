...
@Service
public class FeibaoPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(FeibaoPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理飞宝支付回调】";
        _log.info("====== 开始处理飞宝支付回调通知 ======");
