...
@Service
public class RuizhifuPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(RuizhifuPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理瑞支付回调】";
        _log.info("====== 开始处理瑞支付回调通知 ======");
    ...
    public boolean verifyPayParams(Map<String, Object> payContext) throws Exception {
        ...
        String amount_true = params.getString("amount_true");//实际支付金额
        ...
        long resAmount = new BigDecimal(amount_true).multiply(new BigDecimal(100)).longValue();
        if (dbPayAmt != resAmount) {
            _log.error("金额不一致. outPayAmt={},payOrderId={}", amount, out_trade_no);
