...
@Service
public class YilianbaoPaymentService extends BasePayment {

    private static final MyLog _log = MyLog.getLog(YilianbaoPaymentService.class);
    ...
    public JSONObject pay(PayOrder payOrder) {
        ...
        switch (channelName) {
            case PayConstant.newTradeTypeConstant.TRADE_TYPE_WXPAY:
                retObj = doJuheRyPayReq(payOrder, "3");
                break;
            default:
