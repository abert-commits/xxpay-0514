...
@Service
public class JuhepayPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(JuhepayPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理聚合支付回调】";
        _log.info("====== 开始处理聚合支付回调通知 ======");
