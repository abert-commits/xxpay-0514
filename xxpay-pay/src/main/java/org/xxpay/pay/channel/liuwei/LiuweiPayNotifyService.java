...
@Service
public class LiuweiPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(LiuweiPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理六维支付回调】";
        _log.info("====== 开始处理六维支付回调通知 ======");
    ...
    public boolean verifyPayParams(Map<String, Object> payContext) {
        ...
        // 验证签名
        params.remove("sign");
        String signValue = PayDigestUtil.getSignPhP(params, channelPayConfig.getmD5Key());
