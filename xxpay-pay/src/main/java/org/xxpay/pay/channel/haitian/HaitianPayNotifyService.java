...
@Service
public class HaitianPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(HaitianPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理海天支付回调】";
        _log.info("====== 开始处理海天支付回调通知 ======");
    ...
    public boolean verifyPayParams(Map<String, Object> payContext) throws Exception {
        ...
        // 校验结果是否成功
        String orderNo = params.getString("sh_order"); // 商户订单号
