package org.xxpay.pay.channel.aaa;
...
@Service
public class AaapayPaymentService extends BasePayment {

    private static final MyLog _log = MyLog.getLog(AaapayPaymentService.class);
    ...
    public JSONObject doAaaPayReq(PayOrder payOrder, String channel) {
        ...
        try {
            ...
            map.put("pay_applydate", DateUtil.date2Str(new Date(), DateUtil.FORMAT_YYYY_MM_DD_HH_MM_SS));//订单日期
            ...
            map.put("pay_amount", AmountUtil.convertCent2DollarShort(String.valueOf(payOrder.getAmount())));// 单位 元
            ...
            if (resObj.getString("result").equals("ok")) {
