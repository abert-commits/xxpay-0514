...
@Service
public class BoshengPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(BoshengPayNotifyService.class);
