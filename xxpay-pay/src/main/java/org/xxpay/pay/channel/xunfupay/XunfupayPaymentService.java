...
@Service
public class XunfupayPaymentService extends BasePayment {
    ...
    public JSONObject pay(PayOrder payOrder) {
        ...
        switch (channelName) {
            case PayConstant.newTradeTypeConstant.TRADE_TYPE_ALIPAY_PDDSDK:
                retObj = doXunfupayRyPayReq(payOrder, "1"); //支付宝SDK
                break;
            default:
    ...
    public JSONObject doXunfupayRyPayReq(PayOrder payOrder, String pay_code) {
        String logPrefix = "【迅付支付统一下单】";
        ...
        try {
            ...
            map.put("submit_type","2");//1：form表单跳转提交，返回html; 2：返回Json；
    ...
    public JSONObject query(PayOrder payOrder) {
        ...
        try {
            ...
            if (code.equals("0000")) {
                ...
                System.out.println("迅付------》》》》》》《《《《《《++++++" + map1.toString());
