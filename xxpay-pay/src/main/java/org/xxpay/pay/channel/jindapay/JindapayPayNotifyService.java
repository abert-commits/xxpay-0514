...
@Service
public class JindapayPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(JindapayPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理金达支付回调】";
        _log.info("====== 开始处理金达支付回调通知 ======");
