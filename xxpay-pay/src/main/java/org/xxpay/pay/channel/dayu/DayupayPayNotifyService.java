...
@Service
public class DayupayPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(DayupayPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理大宇支付回调】";
        _log.info("====== 开始处理大宇支付回调通知 ======");
...
//        JSONObject jsonParam = PayDigestUtil.getJSONParam(request);
        ...
        try {
            ...
            params.put("pay_id", request.getParameter("pay_id"));
            params.put("pay_no", request.getParameter("pay_no"));
            params.put("source_amount", request.getParameter("source_amount"));
            ...
            if("00".equals(params.getString("code"))) {
