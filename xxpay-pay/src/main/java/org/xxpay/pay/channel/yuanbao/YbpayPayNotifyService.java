...
@Service
public class YbpayPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(YbpayPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理元宝当面付回调】";
        _log.info("====== 开始处理元宝当面付回调通知 ======");
        ...
        try {
            JSONObject params = JSONObject.parseObject(GetParamsToJSONObject(request).getString("ordersInfo"));
//            JSONObject params =JSONObject.parseObject(GetInput(notifyData));
    ...
    public boolean verifyPayParams(Map<String, Object> payContext) throws Exception {
        ...
        // 校验结果是否成功
        String orderNo = params.getString("outTradeNo"); // 商户唯一订单号
...
//
//        String signStr = amount + orderNo + channelPayConfig.getmD5Key();
//        // md5 加密
