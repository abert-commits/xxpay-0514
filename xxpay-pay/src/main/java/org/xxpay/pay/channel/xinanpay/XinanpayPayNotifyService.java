...
@Service
public class XinanpayPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(XinanpayPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理信安支付回调】";
        _log.info("====== 开始处理信安支付回调通知 ======");
