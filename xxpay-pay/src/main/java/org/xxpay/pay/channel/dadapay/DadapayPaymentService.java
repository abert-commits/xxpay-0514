package org.xxpay.pay.channel.dadapay;
...
@Service
public class DadapayPaymentService extends BasePayment {

    private static final MyLog _log = MyLog.getLog(DadapayPaymentService.class);

    @Override
    public String getChannelName() {
        return PayConstant.CHANNEL_NAME_DADA;
    }
    ...
    public JSONObject pay(PayOrder payOrder) {
        ...
        switch (channelName) {
            case PayConstant.newTradeTypeConstant.TRADE_TYPE_ALIPAY:
                retObj = doXinanRyPayReq(payOrder, "904"); //支付宝H5
                break;
            default:
    ...
    public JSONObject doXinanRyPayReq(PayOrder payOrder, String pay_code) {
        String logPrefix = "【DD支付统一下单】";
    ...
    public JSONObject query(PayOrder payOrder) {
        ...
        try {
            ...
            String res = (String) XXPayUtil.doPostQueryCmd(channelPayConfig.getReqUrl() + "/Pay_Trade_query", sendMsg);
            _log.info("上游返回信息：" + res);
            ...
            if (code.equals("00")) {
                ...
                System.out.println("DD------》》》》》》《《《《《《++++++" + map1.toString());
