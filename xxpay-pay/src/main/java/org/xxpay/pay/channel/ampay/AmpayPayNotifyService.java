...
@Service
public class AmpayPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(AmpayPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理阿M支付回调】";
        _log.info("====== 开始处理阿M支付回调通知 ======");
