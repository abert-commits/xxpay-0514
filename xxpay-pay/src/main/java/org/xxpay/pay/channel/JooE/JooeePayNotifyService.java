...
@Service
public class JooeePayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(JooeePayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理JooE卡回调】";
        _log.info("====== 开始处理JooE卡回调通知 ======");
...
//            JSONObject params =JSONObject.parseObject(GetInput(notifyData));
    ...
    public boolean verifyPayParams(Map<String, Object> payContext) throws Exception {
        ...
        // 校验结果是否成功
        String orderNo = params.getString("m_orderid"); // 商户唯一订单号
        String amount = params.getString("payamount");
        ...
        String signStr = "" + map.get("orderid") + map.get("m_orderid") + map.get("payamount") + channelPayConfig.getmD5Key();
        // md5 加密
        String md5 = PayDigestUtil.md5(signStr, "UTF-8");
        if (!md5.equals(sign)) {
