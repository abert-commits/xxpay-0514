package org.xxpay.pay.channel.jujinpay;
...
@Service
public class JujinpayPaymentService extends BasePayment {

    private static final MyLog _log = MyLog.getLog(JujinpayPaymentService.class);

    @Override
    public String getChannelName() {
        return PayConstant.CHANNEL_NAME_JUJIN;
    }
    ...
    public JSONObject pay(PayOrder payOrder) {
        ...
        switch (channelName) {
            case PayConstant.newTradeTypeConstant.TRADE_TYPE_ALIPAY:
                retObj = doJujinRyPayReq(payOrder, "946"); //支付宝H5
                break;
            default:
    ...
    public JSONObject doJujinRyPayReq(PayOrder payOrder, String pay_code) {
        String logPrefix = "【聚金支付统一下单】";
...
//            map.put("jump","1");
            ...
            if (resObj.getString("code").equals("1000")) {
                String payJujinUrl = resObj.getString("data");
                JSONObject payParams = new JSONObject();
                payParams.put("payJumpUrl", payJujinUrl);
                if (payJujinUrl.contains("form")) {
    ...
    public JSONObject query(PayOrder payOrder) {
        ...
        try {
            ...
            if (code.equals("00")) {
                ...
                System.out.println("聚金------》》》》》》《《《《《《++++++" + map1.toString());
