...
@Service
public class TianxianpayPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(TianxianpayPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理天衔支付回调】";
        _log.info("====== 开始处理天衔支付回调通知 ======");
