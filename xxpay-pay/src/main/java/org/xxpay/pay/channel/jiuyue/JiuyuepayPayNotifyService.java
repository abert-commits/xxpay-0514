...
@Service
public class JiuyuepayPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(JiuyuepayPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理九月支付回调】";
        _log.info("====== 开始处理九月支付回调通知 ======");
