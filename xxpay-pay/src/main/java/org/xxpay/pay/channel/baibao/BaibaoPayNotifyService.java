package org.xxpay.pay.channel.baibao;
...
@Service
public class BaibaoPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(BaibaoPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理百宝支付回调】";
        _log.info("====== 开始处理火山支付回调通知 ======");
