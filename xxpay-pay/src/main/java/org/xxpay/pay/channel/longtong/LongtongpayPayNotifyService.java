...
@Service
public class LongtongpayPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(LongtongpayPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理隆通支付回调】";
        _log.info("====== 开始处理隆通支付回调通知 ======");
