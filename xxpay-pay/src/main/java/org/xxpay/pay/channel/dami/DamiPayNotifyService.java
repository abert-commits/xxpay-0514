...
@Service
public class DamiPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(DamiPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理大咪闲鱼回调】";
        _log.info("====== 开始处理大咪闲鱼回调通知 ======");
    ...
    public boolean verifyPayParams(Map<String, Object> payContext) throws Exception {
        ...
        // 校验结果是否成功
        String orderNo = params.getString("orderid"); // 商户唯一订单号
        ...
        String signStr = "merchant_id="+ map.get("merchant_id") + "&platform_orderid="+map.get("platform_orderid")+"&amount="+ amount+"&key="+channelPayConfig.getmD5Key();
