package org.xxpay.pay.channel.azhifu;
...
@Service
public class AizhifuPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(AizhifuPayNotifyService.class);

    @Override
    public String getChannelName() {
        return PayConstant.CHANNEL_NAME_AIZHIFU;
    }

    @Override
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理爱支付支付回调】";
        _log.info("====== 开始处理爱支付支付回调通知 ======");
