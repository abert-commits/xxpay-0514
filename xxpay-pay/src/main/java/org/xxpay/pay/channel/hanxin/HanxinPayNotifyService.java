package org.xxpay.pay.channel.hanxin;
...
@Service
public class HanxinPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(HanxinPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理韩信三方支付回调】";
        _log.info("====== 开始处理韩信三方支付回调通知 ======");
