...
@Service
public class FuyouPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(FuyouPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理富有支付宝回调】";
        _log.info("====== 开始处理富有支付宝回调通知 ======");
    ...
    public boolean verifyPayParams(Map<String, Object> payContext) throws Exception {
        ...
        // 校验结果是否成功
        String orderNo = params.getString("order_no"); // 商户唯一订单号
