package org.xxpay.pay.channel.xunfei;
...
@Service
public class XunfeiPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(XunfeiPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理讯飞支付回调】";
        _log.info("====== 开始处理讯飞支付回调通知 ======");
