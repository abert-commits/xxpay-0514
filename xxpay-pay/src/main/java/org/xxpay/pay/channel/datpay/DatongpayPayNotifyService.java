...
@Service
public class DatongpayPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(DatongpayPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
         String logPrefix = "【处理大通支付回调】";
        _log.info("====== 开始处理大通支付回调通知 ======");
