...
@Service
public class ChuanqiPaymentService extends BasePayment {

    private static final MyLog _log = MyLog.getLog(ChuanqiPaymentService.class);
    ...
    public JSONObject pay(PayOrder payOrder) {
        ...
        switch (channelName) {
            case PayConstant.newTradeTypeConstant.TRADE_TYPE_ALIPAYQR:
                retObj = doFGPayReq(payOrder, 127); //支付宝扫码
                break;
            default:
