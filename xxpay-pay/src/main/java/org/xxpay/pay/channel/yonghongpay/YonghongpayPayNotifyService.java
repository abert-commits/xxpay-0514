...
@Service
public class YonghongpayPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(YonghongpayPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理勇弘支付回调】";
        _log.info("====== 开始处理勇弘支付回调通知 ======");
