package org.xxpay.pay.channel.qt;
...
@Service
public class QtpayPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(QtpayPayNotifyService.class);
