...
@Service
public class WuerpayPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(WuerpayPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理五二支付回调】";
        _log.info("====== 开始处理五二支付回调通知 ======");
