package org.xxpay.pay.channel.juhepay;
...
@Service
public class TianshipayPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(TianshipayPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理天使支付回调】";
        _log.info("====== 开始处理天使支付回调通知 ======");
