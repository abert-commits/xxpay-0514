...
@Service
public class TiangonPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(TiangonPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理天宫付支付回调】";
        _log.info("====== 开始处理天宫付支付回调通知 ======");
