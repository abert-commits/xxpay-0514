package org.xxpay.pay.channel.hantiaotiao;
...
@Service
public class HantiaotiaoPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(HantiaotiaoPayNotifyService.class);

    @Override
    public String getChannelName() {
        return PayConstant.CHANNEL_NAME_HANTIAOTIAO;
    }

    @Override
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理韩信支付回调】";
        _log.info("====== 开始处理韩信支付回调通知 ======");
