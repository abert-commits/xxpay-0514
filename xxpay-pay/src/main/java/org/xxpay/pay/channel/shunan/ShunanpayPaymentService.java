package org.xxpay.pay.channel.shunan;
...
@Service
public class ShunanpayPaymentService extends BasePayment {

    private static final MyLog _log = MyLog.getLog(ShunanpayPaymentService.class);
    ...
    public JSONObject pay(PayOrder payOrder) {
        ...
        switch (channelName) {
            case PayConstant.newTradeTypeConstant.TRADE_TYPE_ALIPAY:
                retObj = doHuaFeiPayReq(payOrder, "alipay");//支付宝H5
                break;
