...
@Service
public class MashangpayPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(MashangpayPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理马上支付回调】";
        _log.info("====== 开始处理马上支付回调通知 ======");
        ...
        try {
            ...
            params.put("outChannelNo", jsonParam.getString("outChannelNo"));
            ...
            if ("2".equals(params.get("payStatus"))) {
    ...
    public boolean verifyPayParams(Map<String, Object> payContext) throws Exception {
        ...
        // 校验结果是否成功
        String respCode = params.getString("respCode");  // 返回状态码
        String message = params.getString("message"); // 返回信息
        String merchno = params.getString("merchno"); // 商户号
        String payStatus = params.getString("payStatus");   //支付状态
        String outTradeNo = params.getString("outTradeNo"); // 交易流水号
        String amount = params.getString("amount"); //金额
        String outChannelNo = params.getString("outChannelNo"); //平台订单号
        ...
        signMap.put("outChannelNo", outChannelNo);
        // md5 加密
