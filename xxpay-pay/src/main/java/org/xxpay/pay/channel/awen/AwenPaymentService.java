...
@Service
public class AwenPaymentService extends BasePayment {

    private static final MyLog _log = MyLog.getLog(AwenPaymentService.class);
    ...
    public JSONObject doMayiPayReq(PayOrder payOrder, String channel) {
        ...
        try {
            ...
            params.put("mer_user_no", channelPayConfig.getRsapassWord());
