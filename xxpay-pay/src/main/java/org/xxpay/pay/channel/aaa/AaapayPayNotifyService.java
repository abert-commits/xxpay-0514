...
@Service
public class AaapayPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(AaapayPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理AAA付支付回调】";
        _log.info("====== 开始处理AAA付支付回调通知 ======");
