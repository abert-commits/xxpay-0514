...
@Service
public class HuifubaoPaymentService extends BasePayment {

    private static final MyLog _log = MyLog.getLog(HuifubaoPaymentService.class);
    ...
    public JSONObject pay(PayOrder payOrder) {
        ...
        switch (channelName) {
            ...
            case PayConstant.newTradeTypeConstant.TRADE_TYPE_WXPAY:
                retObj = doYIbPayReq(payOrder, "901");
                break;
                //支付宝H5
