...
@Service
public class QtpayPaymentService extends BasePayment {

    private static final MyLog _log = MyLog.getLog(QtpayPaymentService.class);
    ...
    public JSONObject doMayiPayReq(PayOrder payOrder, String channel) {
        ...
        try {
            ...
            String payJumpUrl = resObj.getJSONObject("data").getString("code");
