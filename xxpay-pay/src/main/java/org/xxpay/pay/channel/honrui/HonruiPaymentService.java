...
@Service
public class HonruiPaymentService extends BasePayment {

    private static final MyLog _log = MyLog.getLog(HonruiPaymentService.class);
    ...
    public JSONObject pay(PayOrder payOrder) {
        ...
        switch (channelName) {
            ...
            case PayConstant.newTradeTypeConstant.TRADE_TYPE_ALIPAY:
                retObj = doMayiPayReq(payOrder, "912");
                break;
            //微信H5
