...
@Service
public class YirunPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(YirunPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理亿润支付回调】";
        _log.info("====== 开始处理亿润支付回调通知 ======");
