...
@Service
public class XingchenPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(XingchenPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理星辰支付回调】";
        _log.info("====== 开始处理星辰支付回调通知 ======");
    ...
    public boolean verifyPayParams(Map<String, Object> payContext) throws Exception {
        ...
        // 校验结果是否成功
        String orderNo = params.getString("out_order_no"); // 商户订单号
        ...
        String cksign = PayDigestUtil.getSignNotKey(signMap, channelPayConfig.getmD5Key());
