...
@Service
public class ZhanchepayPaymentService extends BasePayment {

    private static final MyLog _log = MyLog.getLog(ZhanchepayPaymentService.class);
