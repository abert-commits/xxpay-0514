...
@Service
public class YuanzhifuPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(YuanzhifuPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理源支付回调】";
        _log.info("====== 开始处理源支付回调通知 ======");
