...
@Service
public class KukuPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(KukuPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理酷酷咸鱼回调】";
        _log.info("====== 开始处理酷酷咸鱼回调通知 ======");
