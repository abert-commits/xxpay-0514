...
@Service
public class AxiangpayPaymentService extends BasePayment {

    private static final MyLog _log = MyLog.getLog(AxiangpayPaymentService.class);
