...
@Service
public class FeifanPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(FeifanPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理非凡闲鱼回调】";
        _log.info("====== 开始处理非凡闲鱼回调通知 ======");
