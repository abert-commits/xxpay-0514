package org.xxpay.pay.channel.tengan;
...
@Service
public class TenganPaymentService extends BasePayment {

    private static final MyLog _log = MyLog.getLog(TenganPaymentService.class);

    @Override
    public String getChannelName() {
        return PayConstant.CHANNEL_NAME_TENGAN;
    }
    ...
    public JSONObject doTengAnPayReq(PayOrder payOrder, String pay_code) {
        ...
        try {
            ...
            map.put("pay_productname", "腾安支付");//商品名称
    ...
    public JSONObject query(PayOrder payOrder) {
        ...
        try {
            ...
            if (code.equals("00")) {
                ...
                System.out.println("腾安------》》》》》》《《《《《《++++++" + map1.toString());
