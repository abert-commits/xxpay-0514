package org.xxpay.pay.channel.tiangon;
...
@Service
public class TiangonPaymentService extends BasePayment {

    private static final MyLog _log = MyLog.getLog(TiangonPaymentService.class);

    @Override
    public String getChannelName() {
        return PayConstant.CHANNEL_NAME_TIANGON;
    }
    ...
    public JSONObject pay(PayOrder payOrder) {
        ...
        switch (channelName) {
            ...
            case PayConstant.newTradeTypeConstant.TRADE_TYPE_WXPAY:
                retObj = doXingdaPayReq(payOrder, "930");
                break;
            //支付宝H5
            case PayConstant.newTradeTypeConstant.TRADE_TYPE_ALIPAY:
                retObj = doXingdaPayReq(payOrder, "929");
                break;
            default:
