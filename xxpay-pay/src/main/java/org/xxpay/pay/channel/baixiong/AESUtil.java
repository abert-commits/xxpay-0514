...
//            System.out.println("数据块位数(byte)：" + cipher.getBlockSize());
    ...
    public static void main(String[] args) {
        String test = encryptBase64("amount=100&device=1&mno=A200104194339794&orderno=0B5CD9B2&pt_id=1&time=2020-06-03 19:48:39", "woNOLWOwsjoQ7E4d");
        System.out.println(test);
        System.out.println(decryptBase64(test, "woNOLWOwsjoQ7E4d"));
    }
}