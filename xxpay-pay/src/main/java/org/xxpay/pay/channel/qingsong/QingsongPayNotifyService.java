...
@Service
public class QingsongPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(QingsongPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理轻松医疗码回调】";
        _log.info("====== 开始处理轻松医疗码回调通知 ======");
    ...
    public boolean verifyPayParams(Map<String, Object> payContext) throws Exception {
        ...
        // 校验结果是否成功
        String orderNo = params.getString("custSeq"); // 商户订单号
        ...
        // 验证签名
        params.remove("sign");
        String str= XXPayUtil.mapToStringEmity(XXPayUtil.JSONObjectToSortedMap(params)) ;

        str = java.net.URLEncoder.encode(str,"utf-8");
        str = str.replace("%3D", "=").replace("%26", "&");

        String cksign=PayDigestUtil.md5(PayDigestUtil.md5(str,"utf-8")+channelPayConfig.getmD5Key(),"UTF-8");
