...
@Service
public class JqkPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(JqkPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理JQK支付回调】";
        _log.info("====== 开始处理JQK支付回调通知 ======");
        ...
        try {
            ...
            params.put("user_order_id", request.getParameter("user_order_id"));
    ...
    public boolean verifyPayParams(Map<String, Object> payContext) {
        ...
        // 查询payOrder记录
        String payOrderId = params.getString("user_order_id");
