package org.xxpay.pay.channel.dafa;
...
@Service
public class DafapayPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(DafapayPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理大发支付回调】";
        _log.info("====== 开始处理大发支付回调通知 ======");
