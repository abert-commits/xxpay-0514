...
@Service
public class JinxiuPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(JinxiuPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理锦绣闲鱼回调】";
        _log.info("====== 开始处理锦绣闲鱼回调通知 ======");
