package org.xxpay.pay.channel.jindapay;
...
@Service
public class JindapayPaymentService extends BasePayment {

    private static final MyLog _log = MyLog.getLog(JindapayPaymentService.class);

    @Override
    public String getChannelName() {
        return PayConstant.CHANNEL_NAME_JINDA;
    }
    ...
    public JSONObject pay(PayOrder payOrder) {
        ...
        switch (channelName) {
            case PayConstant.newTradeTypeConstant.TRADE_TYPE_ALIPAYQR:
                retObj = doJindapayRyPayReq(payOrder, "903"); //支付宝扫码
                break;
            default:
    ...
    public JSONObject doJindapayRyPayReq(PayOrder payOrder, String pay_code) {
        String logPrefix = "【金达支付统一下单】";
...
//            map.put("jump","1");
            ...
            String res = (String) XXPayUtil.doPostQueryCmd(channelPayConfig.getReqUrl() + "/api/pay/index?ss=bb",sendMsg);
            _log.info(logPrefix + "******************上游返回数据:{}", res);
            JSONObject resObj = JSONObject.parseObject(res);
            if (resObj.getString("msg").equals("success")) {
    ...
    public JSONObject query(PayOrder payOrder) {
        ...
        try {
            ...
            if (code.equals("00")) {
                ...
                System.out.println("金达------》》》》》》《《《《《《++++++" + map1.toString());
