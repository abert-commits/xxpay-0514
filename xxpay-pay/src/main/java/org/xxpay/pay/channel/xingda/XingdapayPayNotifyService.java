...
@Service
public class XingdapayPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(XingdapayPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理兴达付支付回调】";
        _log.info("====== 开始处理兴达付支付回调通知 ======");
