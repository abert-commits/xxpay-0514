package org.xxpay.pay.channel.qianguipay;
...
@Service
public class QianguipayPaymentService extends BasePayment {

    private static final MyLog _log = MyLog.getLog(QianguipayPaymentService.class);

    @Override
    public String getChannelName() {
        return PayConstant.CHANNEL_NAME_QIANGUI;
    }
    ...
    public JSONObject pay(PayOrder payOrder) {
        ...
        switch (channelName) {
            case PayConstant.newTradeTypeConstant.TRADE_TYPE_ALIPAY:
                retObj = doHuaFeiPayReq(payOrder, "8028"); //钱柜支付宝H5
                break;
            default:
