...
@Service
public class WuyiPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(WuyiPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理五一支付回调】";
        _log.info("====== 开始处理五一支付回调通知 ======");
