...
@Service
public class ShunshunPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(ShunshunPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理顺顺支付回调】";
        _log.info("====== 开始处理顺顺支付回调通知 ======");
