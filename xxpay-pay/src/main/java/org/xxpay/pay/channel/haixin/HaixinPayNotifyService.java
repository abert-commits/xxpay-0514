...
@Service
public class HaixinPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(HaixinPayNotifyService.class);
