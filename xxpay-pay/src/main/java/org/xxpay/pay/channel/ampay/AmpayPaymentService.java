package org.xxpay.pay.channel.ampay;
...
@Service
public class AmpayPaymentService extends BasePayment {

    private static final MyLog _log = MyLog.getLog(AmpayPaymentService.class);

    @Override
    public String getChannelName() {
        return PayConstant.CHANNEL_NAME_AM;
    }
    ...
    public JSONObject pay(PayOrder payOrder) {
        ...
        switch (channelName) {
            case PayConstant.newTradeTypeConstant.TRADE_TYPE_ALIPAY_SDK:
                retObj = doAmpayRyPayReq(payOrder, "904"); //支付宝H5
                break;
            default:
    ...
    public JSONObject doAmpayRyPayReq(PayOrder payOrder, String pay_code) {
        String logPrefix = "【阿M支付统一下单】";
    ...
    public JSONObject query(PayOrder payOrder) {
        ...
        try {
            ...
            if (code.equals("00")) {
                ...
                System.out.println("阿M------》》》》》》《《《《《《++++++" + map1.toString());
