package org.xxpay.pay.channel.JooE;//JooEPayNotifyService
...
@Service
public class JooePayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(JooePayNotifyService.class);
