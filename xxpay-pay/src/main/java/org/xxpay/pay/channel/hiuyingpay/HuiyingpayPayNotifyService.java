...
@Service
public class HuiyingpayPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(HuiyingpayPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理汇盈支付回调】";
        _log.info("====== 开始处理汇盈支付回调通知 ======");
...
//        JSONObject jsonParam = PayDigestUtil.getJSONParam(request);
    ...
    public boolean verifyPayParams(Map<String, Object> payContext) throws Exception {
        ...
        String outOrderNo = params.getString("order_id"); // 商户订单号
        ...
        params.remove("sign");
        // md5 加密
        String md5 = PayDigestUtil.getSign(params, channelPayConfig.getmD5Key()).toLowerCase();
        if (!md5.equals(sign)) {
