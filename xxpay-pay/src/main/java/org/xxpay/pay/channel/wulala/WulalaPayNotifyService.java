...
@Service
public class WulalaPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(WulalaPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理乌拉拉支付回调】";
        _log.info("====== 开始处理乌拉拉支付回调通知 ======");
