...
@Service
public class YuanbPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(YuanbPayNotifyService.class);
...
//            JSONObject params =JSONObject.parseObject(GetInput(notifyData));
    ...
    public boolean verifyPayParams(Map<String, Object> payContext) throws Exception {
        ...
        // 校验结果是否成功
        String orderNo = params.getString("sh_order"); // 商户唯一订单号
        String amount = params.getString("money");
