...
@Service
public class XiaobaoPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(XiaobaoPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理小爆脾气支付回调】";
        _log.info("====== 开始处理小爆脾气支付回调通知 ======");
