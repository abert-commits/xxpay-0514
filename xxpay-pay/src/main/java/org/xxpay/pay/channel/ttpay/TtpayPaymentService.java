package org.xxpay.pay.channel.ttpay;
...
@Service
public class TtpayPaymentService extends BasePayment {

    private static final MyLog _log = MyLog.getLog(TtpayPaymentService.class);

    @Override
    public String getChannelName() {
        return PayConstant.CHANNEL_NAME_TTPAY;
    }
    ...
    public JSONObject pay(PayOrder payOrder) {
        ...
        switch (channelName) {
            case PayConstant.newTradeTypeConstant.TRADE_TYPE_UnionPay_WAP:
                retObj = doTTPayReq(payOrder, "8000");//银联H5
                break;
            default:
    ...
    public JSONObject doTTPayReq(PayOrder payOrder, String channel) {
        String logPrefix = "【TT支付统一下单】";
        ...
        try {
            ...
            map.put("extra", "extra"); //附加参数
            map.put("param1","param1");//param参数
            map.put("param2","param2");//param参数
//            map.put("appId",channelPayConfig.getRsaPublicKey());
            ...
            String res = XXPayUtil.doPostQueryCmd(channelPayConfig.getReqUrl() + "/api/pay/create_order", "params="+URLEncoder.encode(sendMsg,"UTF-8"));
