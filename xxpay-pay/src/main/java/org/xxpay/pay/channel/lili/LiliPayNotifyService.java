...
@Service
public class LiliPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(LiliPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理丽丽原生红包回调】";
        _log.info("====== 开始处理丽丽原生红包回调通知 ======");
