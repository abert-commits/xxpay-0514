...
@Service
public class ShoutaoPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(ShoutaoPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理v8手淘支付回调】";
        _log.info("====== 开始处理v8手淘支付回调通知 ======");
