package org.xxpay.pay.channel.bripay;
...
@Service
public class BripayPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(BripayPayNotifyService.class);

    @Override
    public String getChannelName() {
        return PayConstant.CHANNEL_NAME_BRIA;
    }

    @Override
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理Bri支付回调】";
        _log.info("====== 开始处理Bri支付回调通知 ======");
