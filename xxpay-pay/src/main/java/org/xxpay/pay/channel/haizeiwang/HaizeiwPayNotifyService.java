...
@Service
public class HaizeiwPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(HaizeiwPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理海贼王1支付回调】";
        _log.info("====== 开始处理海贼王1支付回调通知 ======");
