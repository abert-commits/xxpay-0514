...
@Service
public class WanjiuPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(WanjiuPayNotifyService.class);
