...
@Service
public class WanjiuPaymentService extends BasePayment {

    private static final MyLog _log = MyLog.getLog(WanjiuPaymentService.class);
    ...
    public JSONObject pay(PayOrder payOrder) {
        ...
        switch (channelName) {
            ...
            case PayConstant.newTradeTypeConstant.TRADE_TYPE_ALIPAY_SDK:
                retObj = doMayiPayReq(payOrder, "915");
                break;
            default:
