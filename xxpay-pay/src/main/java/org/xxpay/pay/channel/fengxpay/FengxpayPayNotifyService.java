...
@Service
public class FengxpayPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(FengxpayPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理风向支付回调】";
        _log.info("====== 开始处理风向支付回调通知 ======");
