package org.xxpay.pay.channel.wawa;
...
@Service
public class WawaPaymentService extends BasePayment {

    private static final MyLog _log = MyLog.getLog(WawaPaymentService.class);


    @Override
    public String getChannelName() {
        return PayConstant.CHANNEL_NAME_WAWA;
    }
    ...
    public JSONObject doFagRyPayReq(PayOrder payOrder, String channel) {
        ...
        try {
            ...
            System.out.println("娃娃支付验签串:<<><><><><><" + "1.0" + channelPayConfig.getMchId() + String.valueOf(amount) + payOrder.getPayOrderId() + payConfig.getNotifyUrl(channelName) +
    ...
    public JSONObject query(PayOrder payOrder) {
        ...
        try {
            ...
            if (code.equals("0000")) {
                ...
                System.out.println("娃娃------》》》》》》《《《《《《++++++" + map1.toString());
