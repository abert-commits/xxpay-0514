...
@Service
public class HxianyuPaymentService extends BasePayment {

    private static final MyLog _log = MyLog.getLog(HxianyuPaymentService.class);
    ...
    public JSONObject doXianYuPayReq(PayOrder payOrder, String channel) {
        ...
        try {
            ...
            String mapString = "" + map.get("merchant_no") + map.get("out_order_no") + map.get("amount") + map.get("pay_type") + map.get("notify_url");
            ...
            String res = XXPayUtil.doPostQueryCmd(channelPayConfig.getReqUrl() + "/order/order/pay", sendMsg, "utf-8");
    ...
    public JSONObject query(PayOrder payOrder) {
        ...
        try {
            ...
            String res = XXPayUtil.doPostQueryCmd(channelPayConfig.getReqUrl() + "/order/order/query", sendMsg, "utf-8");
            _log.info(logPrefix + "******************上游返回数据:{}", res);
