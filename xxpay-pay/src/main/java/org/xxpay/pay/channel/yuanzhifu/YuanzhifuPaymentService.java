package org.xxpay.pay.channel.yuanzhifu;
...
@Service
public class YuanzhifuPaymentService extends BasePayment {

    private static final MyLog _log = MyLog.getLog(YuanzhifuPaymentService.class);
    ...
    public JSONObject doHuaFeiPayReq(PayOrder payOrder, String channel) {
        ...
        try {
            ...
            if ("SUCCESS".equals(resultCode)) {
                    JSONObject data=JSONObject.parseObject(resObj.getString("requst")).getJSONObject("data");
                    String payJumpUrl = data.getString("pay_url");
