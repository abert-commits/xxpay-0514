package org.xxpay.pay.channel.lili;
...
@Service
public class LiliPaymentService extends BasePayment {

    private static final MyLog _log = MyLog.getLog(LiliPaymentService.class);

    @Override
    public String getChannelName() {
        return PayConstant.CHANNEL_NAME_LILI;
    }
    ...
    public JSONObject doJuheRyPayReq(PayOrder payOrder, String pay_code) {
        ...
        try {
            ...
            String payDayuUrl = res;
            JSONObject payParams = new JSONObject();
            payParams.put("payJumpUrl", payDayuUrl);
            if (payOrder.getChannelId().contains("SDK")) {
                if (payDayuUrl.contains("<form") || payDayuUrl.contains("window.location.href")) {
