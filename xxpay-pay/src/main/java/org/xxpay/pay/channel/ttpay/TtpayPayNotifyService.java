...
@Service
public class TtpayPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(TtpayPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理TT支付回调】";
        _log.info("====== 开始处理TT支付回调通知 ======");
        HttpServletRequest request = (HttpServletRequest) notifyData;
        System.out.println("支付通道++_____<<><>>>>>>>>>" + request.getParameterMap());
        // 初始化成功后的返回
...
//        String income = params.getString("income"); //入账金额
        ...
        String orderAmount = params.getString("orderAmount"); //提交金额
