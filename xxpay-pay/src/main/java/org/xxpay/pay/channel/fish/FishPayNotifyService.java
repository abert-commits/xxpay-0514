...
@Service
public class FishPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(FishPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理鱼儿支付回调】";
        _log.info("====== 开始处理鱼儿支付回调通知 ======");
...
//        JSONObject jsonParam = PayDigestUtil.getJSONParam(request);
        ...
        try {
            ...
            params.put("platform_order_no", request.getParameter("platform_order_no"));
    ...
    public boolean verifyPayParams(Map<String, Object> payContext) throws Exception {
        ...
        // 校验结果是否成功
        String uid = params.getString("uid");  //商户号
        ...
        String order_no = params.getString("order_no"); // 商户订单号
        String platform_order_no = params.getString("platform_order_no"); //交易流水号
        String time = params.getString("time"); //交易时间
        ...
        signMap.put("platform_order_no", platform_order_no);
