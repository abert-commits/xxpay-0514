...
@Service
public class LianzpayPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(LianzpayPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理联众支付回调】";
        _log.info("====== 开始处理联众支付回调通知 ======");
    ...
    public boolean verifyPayParams(Map<String, Object> payContext) throws Exception {
        ...
        // 校验结果是否成功
        String orderNo = params.getString("businessnumber"); // 商户订单号
        ...
        String signString = XXPayUtil.mapToStringEmity(signMap);
        String verifySign = PayDigestUtil.md5(signString+"&"+channelPayConfig.getmD5Key(), "utf-8").toUpperCase();
