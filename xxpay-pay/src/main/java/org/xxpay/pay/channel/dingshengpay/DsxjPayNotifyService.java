...
@Service
public class DsxjPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(DsxjPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理鼎盛现金红包回调】";
        _log.info("====== 开始处理鼎盛现金红包回调通知 ======");
...
//            JSONObject params = GetParamsToJSONObject(request);
    ...
    public boolean verifyPayParams(Map<String, Object> payContext) throws Exception {
        ...
        if (dbPayAmt != Long.valueOf(amount).longValue()) {
