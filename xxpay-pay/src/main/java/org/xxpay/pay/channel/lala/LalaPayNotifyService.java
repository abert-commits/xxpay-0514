package org.xxpay.pay.channel.lala;
...
@Service
public class LalaPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(LalaPayNotifyService.class);
