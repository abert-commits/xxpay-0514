...
@Service
public class NfxianyuPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(NfxianyuPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理nf咸鱼回调】";
        _log.info("====== 开始处理nf咸鱼回调通知 ======");
        ...
        try {
            ...
            if(params.getString("result_code").equals("0000")&&params.getString("state").equals("TRADE_SUCCESS")) {
    ...
    public boolean verifyPayParams(Map<String, Object> payContext) throws Exception {
        ...
        // 校验结果是否成功
        String orderNo = params.getString("mer_order_no"); // 商户唯一订单号
        ...
        String sendMsg = XXPayUtil.mapToStringO(params).replace(">", "");
        String resign = PayDigestUtil.String2SHA256(sendMsg+"&key="+channelPayConfig.getmD5Key()).toUpperCase();
