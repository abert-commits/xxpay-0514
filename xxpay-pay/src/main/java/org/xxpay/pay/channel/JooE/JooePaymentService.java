package org.xxpay.pay.channel.JooE;// JooEPaymentService
...
public class JooePaymentService extends BasePayment {

    private static final MyLog _log = MyLog.getLog(JooePaymentService.class);
    ...
    public JSONObject doMayiPayReq(PayOrder payOrder, String channel) {
        ...
        try {
            ...
            map.put("channel_id", "jdecard");//支付类型
            String channelId = payOrder.getChannelId();
