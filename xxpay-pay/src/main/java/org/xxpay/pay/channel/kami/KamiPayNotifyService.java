package org.xxpay.pay.channel.kami;
...
@Service
public class KamiPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(KamiPayNotifyService.class);

    @Override
    public String getChannelName() {
        return PayConstant.CHANNEL_NAME_KAMI;
    }

    @Override
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理自营卡密支付回调】";
        _log.info("====== 开始处理自营卡密支付回调通知 ======");
