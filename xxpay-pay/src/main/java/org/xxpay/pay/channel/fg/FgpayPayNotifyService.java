...
@Service
public class FgpayPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(FgpayPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理FG支付回调】";
        _log.info("====== 开始处理FG支付回调通知 ======");
        ...
        try {
            ...
            _log.info(logPrefix + "====== 完成处理FG支付回调通知 ======");
