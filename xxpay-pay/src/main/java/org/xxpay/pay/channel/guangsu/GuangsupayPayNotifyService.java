...
@Service
public class GuangsupayPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(GuangsupayPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理光速支付回调】";
        _log.info("====== 开始处理光速支付回调通知 ======");
        HttpServletRequest request = (HttpServletRequest) notifyData;
        System.out.println("光速回调参数处理" + request.getParameterMap());
        //获取到JSONObject
