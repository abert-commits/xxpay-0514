...
@Service
public class YuanbaopayPaymentService extends BasePayment {

    private static final MyLog _log = MyLog.getLog(YuanbaopayPaymentService.class);
    ...
    public JSONObject pay(PayOrder payOrder) {
        ...
        switch (channelName) {
            ...
            case PayConstant.newTradeTypeConstant.TRADE_TYPE_ALIPAY:
                retObj = doMayiPayReq(payOrder, "5");
                break;
            default:
    ...
    public JSONObject doMayiPayReq(PayOrder payOrder, String channel) {
        ...
        try {
            ...
            if (resObj.getString("RState") .equals("1")) {
    ...
    public JSONObject query(PayOrder payOrder) {
        ...
        try {
            ...
            SortedMap map = new TreeMap();
            map.put("mchId", channelPayConfig.getMchId());//商户编号
            map.put("orderNo", payOrder.getPayOrderId());//訂單號
