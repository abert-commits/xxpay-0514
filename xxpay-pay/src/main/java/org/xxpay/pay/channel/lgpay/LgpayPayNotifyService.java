...
@Service
public class LgpayPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(LgpayPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理LG支付回调】";
        _log.info("====== 开始处理LG支付回调通知 ======");
