package org.xxpay.pay.channel.huzhou;
...
@Service
public class HuzhouPaymentService extends BasePayment {

    private static final MyLog _log = MyLog.getLog(HuzhouPaymentService.class);
    ...
    public JSONObject pay(PayOrder payOrder) {
        ...
        switch (channelName) {
            ...
            case PayConstant.newTradeTypeConstant.TRADE_TYPE_ALIPAY:
                retObj = doMayiPayReq(payOrder, "1053");
                break;
            default:
    ...
    public JSONObject doMayiPayReq(PayOrder payOrder, String channel) {
        ...
        try {
            ...
            String res = XXPayUtil.doPostQueryCmd(channelPayConfig.getReqUrl() + "/paididx/index.html", sendMsg);
