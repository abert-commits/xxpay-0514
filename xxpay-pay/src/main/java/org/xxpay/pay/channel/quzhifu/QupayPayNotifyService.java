...
@Service
public class QupayPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(QupayPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理趣支付回调】";
        _log.info("====== 开始处理趣支付回调通知 ======");
