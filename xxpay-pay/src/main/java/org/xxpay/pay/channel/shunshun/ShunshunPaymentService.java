package org.xxpay.pay.channel.shunshun;
...
@Service
public class ShunshunPaymentService extends BasePayment {

    private static final MyLog _log = MyLog.getLog(ShunshunPaymentService.class);
