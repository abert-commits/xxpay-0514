...
@Service
public class MidoupayPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(MidoupayPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理米兜支付回调】";
        _log.info("====== 开始处理米兜支付回调通知 ======");
