...
@Service
public class WawapayPaymentService extends BasePayment {

    private static final MyLog _log = MyLog.getLog(WawapayPaymentService.class);
    ...
    public JSONObject pay(PayOrder payOrder) {
        ...
        switch (channelName) {
            case PayConstant.newTradeTypeConstant.TRADE_TYPE_ALIPAY:
                retObj = doWawaPayReq(payOrder, "8007"); //pay.alipay.h5 支付宝H5
                break;
            default:
