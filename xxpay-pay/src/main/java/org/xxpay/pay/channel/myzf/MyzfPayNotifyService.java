...
@Service
public class MyzfPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(MyzfPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理观音桥转卡支付回调】";
        _log.info("====== 开始处理观音桥转卡支付回调通知 ======");
...
//        JSONObject jsonParam = PayDigestUtil.getJSONParam(request);
    ...
    public boolean verifyPayParams(Map<String, Object> payContext) throws Exception {
        ...
        // 校验结果是否成功
        String outOrderNo = params.getString("merchantOrderSn"); // 商户订单号
