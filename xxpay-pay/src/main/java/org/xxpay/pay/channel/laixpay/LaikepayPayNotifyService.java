...
@Service
public class LaikepayPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(LaikepayPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理莱兄支付回调】";
        _log.info("====== 开始处理莱兄支付回调通知 ======");
