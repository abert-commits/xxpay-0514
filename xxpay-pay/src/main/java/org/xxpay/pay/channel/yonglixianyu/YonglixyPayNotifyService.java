...
@Service
public class YonglixyPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(YonglixyPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理拉拉现金红包回调】";
        _log.info("====== 开始处理拉拉现金红包回调通知 ======");
