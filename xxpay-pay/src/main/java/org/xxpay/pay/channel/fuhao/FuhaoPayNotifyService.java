...
@Service
public class FuhaoPayNotifyService extends BasePayNotify {

    private static final MyLog _log = MyLog.getLog(FuhaoPayNotifyService.class);
    ...
    public boolean verifyPayParams(Map<String, Object> payContext) throws Exception {
        ...
        // md5 加密
        String verify = PayDigestUtil.md5( channelPayConfig.getMchId()
                +money+outTradeNo+
