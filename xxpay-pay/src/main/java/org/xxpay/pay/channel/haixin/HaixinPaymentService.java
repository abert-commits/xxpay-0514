package org.xxpay.pay.channel.haixin;
...
@Service
public class HaixinPaymentService extends BasePayment {

    private static final MyLog _log = MyLog.getLog(HaixinPaymentService.class);
    ...
    public JSONObject doJuheRyPayReq(PayOrder payOrder, String pay_code) {
        ...
        try {
            ...
            String payJumpUrl = XXPayUtil.buildRequestHtml(map, channelPayConfig.getReqUrl() + "/Pay_Index.html");
    ...
    public JSONObject query(PayOrder payOrder) {
        ...
        try {
            ...
            if (code.equals("00")) {
                ...
                //核对验签
                if (!signMd5.equals(ressign.toLowerCase())) {
                    retObj.put("status", "1");
