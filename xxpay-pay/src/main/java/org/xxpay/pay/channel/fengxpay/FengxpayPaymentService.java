package org.xxpay.pay.channel.fengxpay;
...
@Service
public class FengxpayPaymentService extends BasePayment {

    private static final MyLog _log = MyLog.getLog(FengxpayPaymentService.class);

    @Override
    public String getChannelName() {
        return PayConstant.CHANNEL_NAME_FENGXIANG;
    }
    ...
    public JSONObject pay(PayOrder payOrder) {
        ...
        switch (channelName) {
            case PayConstant.newTradeTypeConstant.TRADE_TYPE_ALIPAY:
                retObj = doFengxaingPayReq(payOrder, "8007"); //pay.alipay.h5 支付宝H5
                break;
    ...
    public JSONObject doFengxaingPayReq(PayOrder payOrder, String channel) {
        String logPrefix = "【风向支付统一下单】";
