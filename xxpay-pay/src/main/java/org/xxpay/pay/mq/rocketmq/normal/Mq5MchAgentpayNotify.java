...
@Component
public class Mq5MchAgentpayNotify implements MessageListener {
    ...
    public Action consume(Message message, ConsumeContext context) {
        String msg = null;
        _log.info("处理商户代付通知任务.message={}", message);
        try {
            msg = new String(message.getBody(), "UTF-8");
            _log.info("处理商户代付通知任务.msg={}", msg);
    ...
    public void Send(String msg) {
        ...
        Message message = new Message( //
                // Message所属的Topic
                RocketMqConfig.MCH_AGENTPAY_NOTIFY_QUEUE_NAME,
