...
@Component
public class Mq5MchTransNotify implements MessageListener {


    private static final MyLog _log = MyLog.getLog(Mq5MchTransNotify.class);
    ...
    public Action consume(Message message, ConsumeContext context) {
        ...
        try {
            ...
            if("success".equalsIgnoreCase(httpResult)){
                // 修改支付订单表
                try {
                    int result = rpcCommonService.rpcTransOrderService.updateStatus4Complete(orderId);
    ...
    public void Send(String msg) {
        ...
        Message message = new Message( //
                // Message所属的Topic
                RocketMqConfig.MCH_TRANS_NOTIFY_QUEUE_NAME,
