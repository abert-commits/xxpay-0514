...
public class AliSmsUtil {
    ...
    public static SendSmsResponse sendSms(Map<String, String> smsMap) throws ClientException {
        ...
        //必填:待发送手机号
        request.setPhoneNumbers(smsMap.get("phoneNumbers"));
        //必填:短信签名-可在短信控制台中找到
        request.setSignName(smsMap.get("signName"));
        //必填:短信模板-可在短信控制台中找到
        request.setTemplateCode(smsMap.get("templateCode"));
        //可选:模板中的变量替换JSON串,如模板内容为"亲爱的${name},您的验证码为${code}"时,此处的值为
        request.setTemplateParam(smsMap.get("templateParam"));
