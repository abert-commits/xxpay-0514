...
public class PaydemoController extends BaseController {
    ...
    public ResponseEntity<?> create(HttpServletRequest request) {
        ...
        JSONObject retObj = createPayOrder(type, mchInfo.getMchId(), mchInfo.getPrivateKey(), appId, productId, amountB.toString(), subject, body, notifyUrl, returnUrl, extra);
        if(retObj == null) {
    ...
    JSONObject createPayOrder(String type, Long mchId, String key, String appId,
                              String productId, String amount, String subject, String body, String notifyUrl, String returnUrl, String extra) {
