...
public class PayType implements Serializable {
    ...
    public boolean equals(Object that) {
        ...
        return (this.getPayTypeCode() == null ? other.getPayTypeCode() == null : this.getPayTypeCode().equals(other.getPayTypeCode()))
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + ((getPayTypeCode() == null) ? 0 : getPayTypeCode().hashCode());
