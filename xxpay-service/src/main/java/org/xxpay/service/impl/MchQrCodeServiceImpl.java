...
public class MchQrCodeServiceImpl implements IMchQrCodeService {
    ...
    void setCriteria(MchQrCodeExample.Criteria criteria, MchQrCode mchQrCode) {
        if(mchQrCode != null) {
            ...
            if(StringUtils.isNotBlank(mchQrCode.getAppId())) criteria.andAppIdEqualTo(mchQrCode.getAppId());
        }
    }
