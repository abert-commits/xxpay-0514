...
public class TransOrderServiceImpl implements ITransOrderService {
    ...
    public TransOrder selectByMchIdAndMchTransNo(Long mchId, String mchTransNo) {
        TransOrderExample example = new TransOrderExample();
        TransOrderExample.Criteria criteria = example.createCriteria();
        criteria.andMchIdEqualTo(mchId);
    ...
    public int updateStatus4Complete(String transOrderId) {
        ...
        TransOrderExample.Criteria criteria = example.createCriteria();
        criteria.andTransOrderIdEqualTo(transOrderId);
        List values = org.springframework.util.CollectionUtils.arrayToList(new Byte[] {
    ...
    void setCriteria(TransOrderExample.Criteria criteria, TransOrder transOrder, Date createTimeStart, Date createTimeEnd) {
        if(transOrder != null) {
            if(transOrder.getMchId() != null) criteria.andMchIdEqualTo(transOrder.getMchId());
